@extends('layouts.base', ['title' => 'Around | Single Post v.1'])
    ...
    <section class="container py-5 mt-5 mb-md-2 mb-lg-3 mb-xl-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="pt-lg-3 pb-lg-4 pb-2 breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('third', ['pages', 'blog', 'grid-sidebar'])}}">Blog</a></li>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 pb-2 pb-lg-0 mb-4 mb-lg-0">
                <h1 class="display-4 pb-2 pb-lg-3">How to look for inspiration for new goals in life and remember to give yourself a break?</h1>
            ...
            <aside class="col-lg-3 offset-xl-1 pt-4 pt-lg-0" style="margin-top: -7rem;">
                <div class="position-sticky top-0 mt-2 mt-md-3 mt-lg-0" style="padding-top: 7rem;">
                    ...
                    <div class="d-flex flex-wrap mt-n3 ms-n3 mb-lg-5 mb-4 pb-3 pb-lg-0">
                        <a class="btn btn-outline-secondary rounded-pill mt-3 ms-3" href="#">Nature</a>
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="border-bottom pb-3 mb-3">
                            <span class="h6 mb-0">
                                <a href="{{ route('third', ['pages', 'blog', 'single-v2'])}}">Instagram trends that will definitely work and bring results in the new 2022</a>
                            </span>
                        </li>
                        <li class="border-bottom pb-3 mb-3">
                            <span class="h6 mb-0">
                                <a href="{{ route('third', ['pages', 'blog', 'single-v3'])}}">A session with a psychologist as a personal choice</a>
                            </span>
                        </li>
                        <li class="border-bottom pb-3 mb-3">
                            <span class="h6 mb-0">
                        ...
                        <li>
                            <span class="h6 mb-0">
                                <a href="{{ route('third', ['pages', 'blog', 'single-v3'])}}">How to look for inspiration for new goals in life?</a>
                            </span>
                        </li>
                    </ul>
                </div>
            ...
            <div class="swiper-wrapper">
                ...
                <article class="swiper-slide">
                    <div class="position-relative">
                        ...
                        <h3 class="h4 mt-4 mb-0">
                            <a class="stretched-link" href="{{ route('third', ['pages', 'blog', 'single-v2'])}}">The fashion for eco bags with vintage prints will still be relevant for more than one year</a>
                        </h3>
                    </div>
                </article>
                ...
                <article class="swiper-slide">
                    <div class="position-relative">
                        ...
                        <h3 class="h4 mt-4 mb-0">
                            <a class="stretched-link" href="{{ route('third', ['pages', 'blog', 'single-v2'])}}">A session with a psychologist as a personal choice or a fashion trend in society</a>
                        </h3>
                    </div>
                </article>
