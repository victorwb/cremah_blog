@extends('layouts.base', ['title' => 'Around UI Kit | Utilities'])
        ...
        <ul class="nav flex-column">
          <li class="nav-item" id="utils">
            ...
            <ul class="nav flex-column border-start ps-3 ms-2 mb-2">
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#bg-faded" data-scroll="data-scroll">Faded background colors</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#image-overlay" data-scroll="data-scroll">Translucent image overlay</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#gradient-text" data-scroll="data-scroll">Gradient text</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#opacity" data-scroll="data-scroll">Opacity</a>
              </li>
            </ul>
          </li>
        </ul>
...
<section class="container pt-5 pb-4">
  <div class="row pt-5 pb-2 pb-sm-3">
    <div class="col-lg-9 offset-lg-3 position-relative z-5">
      <h1 class="pt-lg-4">Around utilities</h1>
      <div class="d-flex flex-wrap flex-md-nowrap justify-content-between pb-3">
        <p class="text-body-secondary">Custom Around classes with a purpose to reduce the frequency of highly repetitive declarations.</p>
      ...
      <section class="card border-0 mb-4" id="bg-faded">
        <div class="card-body pb-0">
          <h2 class="h4 mb-n2">Faded background colors</h2>
        </div>
        ...
        <div class="card-body">
          <div class="tab-content">
            <div class="tab-pane fade show active" id="preview1" role="tabpanel">
              <div class="bg-primary bg-opacity-10 p-4 text-center mb-4">
                <h5 class="text-primary py-2 mb-0">Primary faded background</h5>
              </div>
              <div class="bg-secondary p-4 text-center mb-4">
                <h5 class="py-2 mb-0">Secondary background</h5>
              </div>
              <div class="bg-success bg-opacity-10 p-4 text-center mb-4">
                <h5 class="text-success py-2 mb-0">Success faded background</h5>
              </div>
              <div class="bg-danger bg-opacity-10 p-4 text-center mb-4">
                <h5 class="text-danger py-2 mb-0">Danger faded background</h5>
              </div>
              <div class="bg-warning bg-opacity-10 p-4 text-center mb-4">
                <h5 class="text-warning py-2 mb-0">Warning faded background</h5>
              </div>
              <div class="bg-info bg-opacity-10 p-4 text-center mb-4">
                <h5 class="text-info py-2 mb-0">Info faded background</h5>
              </div>
              <div class="bg-dark bg-opacity-10 p-4 text-center mb-4">
                <h5 class="text-dark py-2 mb-0">Dark faded background</h5>
              </div>
            </div>
            <div class="tab-pane fade" id="html1" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Primary faded background --&gt;
...
&lt;div class=&quot;bg-dark bg-opacity-10&quot;&gt;...&lt;/div&gt;</code></pre>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="card border-0 mb-4" id="image-overlay">
        <div class="card-body pb-0">
          <h2 class="h4 mb-n2">Translucent image overlay</h2>
        </div>
        <div class="card-header">
          <ul class="nav nav-tabs card-header-tabs flex-nowrap align-items-center mb-n1" role="tablist">
            <li class="nav-item me-3">
          ...
          <div class="tab-content">
            <div class="tab-pane fade show active" id="preview2" role="tabpanel">
              <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                <div class="col">
                  <div class="position-relative bg-size-cover bg-position-center py-5" style="background-image: url(/img/landing/corporate/features/03.jpg);">
                    <span class="position-absolute top-0 start-0 w-100 h-100 bg-primary opacity-70"></span>
                    <div class="position-relative fs-lg fw-semibold text-white text-center z-5 py-5">Primary overlay</div>
                  </div>
                </div>
                <div class="col">
                  <div class="position-relative bg-size-cover bg-position-center py-5" style="background-image: url(/img/landing/corporate/features/03.jpg);">
                    <span class="position-absolute top-0 start-0 w-100 h-100 bg-success opacity-70"></span>
                    <div class="position-relative fs-lg fw-semibold text-white text-center z-5 py-5">Success overlay</div>
                  </div>
                </div>
                <div class="col">
                  <div class="position-relative bg-size-cover bg-position-center py-5" style="background-image: url(/img/landing/corporate/features/03.jpg);">
                    <span class="position-absolute top-0 start-0 w-100 h-100 bg-danger opacity-70"></span>
                    <div class="position-relative fs-lg fw-semibold text-white text-center z-5 py-5">Danger overlay</div>
                  </div>
                </div>
                <div class="col">
                  <div class="position-relative bg-size-cover bg-position-center py-5" style="background-image: url(/img/landing/corporate/features/03.jpg);">
                    <span class="position-absolute top-0 start-0 w-100 h-100 bg-warning opacity-70"></span>
                    <div class="position-relative fs-lg fw-semibold text-white text-center z-5 py-5">Warning overlay</div>
                  </div>
                </div>
                <div class="col">
                  <div class="position-relative bg-size-cover bg-position-center py-5" style="background-image: url(/img/landing/corporate/features/03.jpg);">
                    <span class="position-absolute top-0 start-0 w-100 h-100 bg-info opacity-70"></span>
                    <div class="position-relative fs-lg fw-semibold text-white text-center z-5 py-5">Info overlay</div>
                  </div>
                </div>
                <div class="col">
                  <div class="position-relative bg-size-cover bg-position-center py-5" style="background-image: url(/img/landing/corporate/features/03.jpg);">
                    <span class="position-absolute top-0 start-0 w-100 h-100 bg-dark opacity-60"></span>
                    <div class="position-relative fs-lg fw-semibold text-white text-center z-5 py-5">Dark overlay</div>
                  </div>
                </div>
              </div>
            </div>
            <div class="tab-pane fade" id="html2" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Primary overlay --&gt;
...
&lt;/div&gt;</code></pre>
      ...
      <!-- Gradient text -->
      <section class="card border-0 mb-4" id="gradient-text">
        <div class="card-body pb-0">
          <h2 class="h4 mb-n2">Gradient text</h2>
        </div>
        <div class="card-header">
          <ul class="nav nav-tabs card-header-tabs flex-nowrap align-items-center mb-n1" role="tablist">
            <li class="nav-item me-3">
        ...
        <div class="card-body">
          <div class="tab-content">
            ...
            <div class="tab-pane fade" id="html3" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Gradient text --&gt;
&lt;h2 class=&quot;display-4&quot;&gt;
  &lt;span class=&quot;text-gradient&quot;&gt;I'm a gradient text&lt;/span&gt;
&lt;/h2&gt;</code></pre>
            </div>
      ...
      <!-- Opacity -->
      <section class="card border-0 mb-4" id="opacity">
        <div class="card-body pb-0">
          <h2 class="h4 mb-n2">Opacity</h2>
        </div>
        <div class="card-header">
          <ul class="nav nav-tabs card-header-tabs flex-nowrap align-items-center mb-n1" role="tablist">
            <li class="nav-item me-3">
          ...
          <div class="tab-content">
            <div class="tab-pane fade show active" id="preview4" role="tabpanel">
              <div class="d-flex flex-wrap pt-1">
                <span class="text-dark opacity-10 mb-3 me-4">Opacity 10%</span>
                <span class="text-dark opacity-20 mb-3 me-4">Opacity 20%</span>
                <span class="text-dark opacity-25 mb-3 me-4">Opacity 25%</span>
                <span class="text-dark opacity-30 mb-3 me-4">Opacity 30%</span>
                <span class="text-dark opacity-40 mb-3 me-4">Opacity 40%</span>
                <span class="text-dark opacity-50 mb-3 me-4">Opacity 50%</span>
                <span class="text-dark opacity-60 mb-3 me-4">Opacity 60%</span>
                <span class="text-dark opacity-70 mb-3 me-4">Opacity 70%</span>
                <span class="text-dark opacity-75 mb-3 me-4">Opacity 75%</span>
                <span class="text-dark opacity-80 mb-3 me-4">Opacity 80%</span>
                <span class="text-dark opacity-90 mb-3 me-4">Opacity 90%</span>
                <span class="text-dark opacity-100 mb-3 me-4">Opacity 100%</span>
              </div>
            </div>
            <div class="tab-pane fade" id="html4" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Opacity --&gt;
