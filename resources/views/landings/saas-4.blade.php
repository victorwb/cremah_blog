@extends('layouts.base', ['title' => 'Around | SaaS v.4'])
    ...
    <main class="page-wrapper">
        ...
        <section class="position-relative bg-dark pt-lg-4 pt-xl-5">
            <div class="jarallax position-absolute top-0 start-0 w-100 h-100" data-jarallax data-speed="0.4">
                <div class="jarallax-img"
                     style="background-image: url(/img/landing/saas-4/hero-bg-pattern.png);"></div>
            </div>
            <div class="container position-relative z-2 pt-2 pt-sm-4 pt-md-5">
                <div class="row justify-content-center pt-5">
                    <div class="col-lg-9 col-xl-8 text-center pt-5 mt-1">
                        ...
                        <h1 class="display-4 text-white pt-3 mt-3 mb-4">Powerful AI models to serve your business
                            needs</h1>
                        <p class="text-white opacity-70 fs-xl">Our robust platform is designed to handle large volumes
                            of data and processing power, making it perfect for businesses of all sizes.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex position-absolute bottom-0 start-0 w-100 overflow-hidden mb-n1"
                ...
                <div class="position-relative start-50 translate-middle-x flex-shrink-0" style="width: 3774px;">
                    <svg width="3774" height="201" viewBox="0 0 3774 201" fill="none"
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <a href="#" class="card card-hover zoom-effect border-0 rounded-5 overflow-hidden">
                            ...
                            <div class="position-absolute bottom-0 w-100 z-2 p-4">
                                <div class="px-md-3">
                                    <h3 class="h4 text-white mb-0">E-commerce</h3>
                            ...
                            <div class="zoom-effect-wrapper">
                                <div class="zoom-effect-img">
                                    <img src="/img/landing/saas-4/categories/ecommerce.jpg" alt="Ecommerce">
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <a href="#" class="card card-hover zoom-effect border-0 rounded-5 overflow-hidden">
                            ...
                            <div class="position-absolute bottom-0 w-100 z-2 p-4">
                                <div class="px-md-3">
                                    <h3 class="h4 text-white mb-0">Transportation</h3>
                                    <div class="d-flex align-items-center justify-content-between opacity-0">
                            ...
                            <div class="zoom-effect-wrapper">
                                <div class="zoom-effect-img">
                                    <img src="/img/landing/saas-4/categories/transportation.jpg"
                                         alt="Transportation">
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="swiper-slide">
                        <a href="#" class="card card-hover zoom-effect border-0 rounded-5 overflow-hidden">
                            ...
                            <div class="position-absolute bottom-0 w-100 z-2 p-4">
                                <div class="px-md-3">
                                    <h3 class="h4 text-white mb-0">Marketing</h3>
                                    <div class="d-flex align-items-center justify-content-between opacity-0">
                            ...
                            <div class="zoom-effect-wrapper">
                                <div class="zoom-effect-img">
                                    <img src="/img/landing/saas-4/categories/marketing.jpg" alt="Marketing">
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <a href="#" class="card card-hover zoom-effect border-0 rounded-5 overflow-hidden">
                            ...
                            <div class="position-absolute bottom-0 w-100 z-2 p-4">
                                <div class="px-md-3">
                                    <h3 class="h4 text-white mb-0">Robotics</h3>
                                    <div class="d-flex align-items-center justify-content-between opacity-0">
                                        <span class="text-white fs-xs text-truncate opacity-70 pe-3">Enhancing robot learning, improve robotic precision</span>
                                        <i class="ai-circle-arrow-right fs-3 text-primary"></i>
                                    </div>
                                </div>
                            </div>
                            <div class="zoom-effect-wrapper">
                                <div class="zoom-effect-img">
                                    <img src="/img/landing/saas-4/categories/robotics.jpg" alt="Robotics">
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <a href="#" class="card card-hover zoom-effect border-0 rounded-5 overflow-hidden">
                            ...
                            <div class="position-absolute bottom-0 w-100 z-2 p-4">
                                <div class="px-md-3">
                                    <h3 class="h4 text-white mb-0">Programming</h3>
                                    <div class="d-flex align-items-center justify-content-between opacity-0">
                                        <span class="text-white fs-xs text-truncate opacity-70 pe-3">Code generation, code debugging and optimization</span>
                                        <i class="ai-circle-arrow-right fs-3 text-primary"></i>
                                    </div>
                                </div>
                            </div>
                            <div class="zoom-effect-wrapper">
                                <div class="zoom-effect-img">
                                    <img src="/img/landing/saas-4/categories/programming.jpg" alt="Programming">
                                </div>
                            </div>
                        </a>
                    </div>
        ...
        <section class="position-relative overflow-hidden py-5">
            <span class="position-absolute top-0 start-0 w-100 h-100 d-dark-mode-none"
                  style="background: linear-gradient(141deg, rgba(255, 255, 255, .01) 17.3%, #f6f9fc 78.21%);"></span>
            <div class="position-absolute top-0 start-0 w-100 h-100 d-none d-dark-mode-block"
                 style="background: linear-gradient(141deg, rgba(18, 21, 25, .00) 17.3%, rgba(255, 255, 255, .03) 78.21%);"></div>
            ...
            <div class="container position-relative z-2 pt-3 pt-md-4 pt-lg-5 mt-lg-2 mt-xl-4">
                ...
                <div class="row align-items-center justify-content-center py-4 py-md-5 my-1 my-sm-3 my-md-0 my-xl-3">
                    <div
                        class="col-11 col-sm-9 col-md-7 col-lg-6 offset-lg-1 order-md-2 pb-2 pb-sm-3 pb-md-0 mb-4 mb-md-0">
                        <div class="parallax" style="max-width: 636px;">
                            ...
                            <div class="parallax-layer" style="padding-right: 24.2%;" data-depth="0.1">
                                <img src="/img/landing/saas-4/use-cases/data-analysis/line-chart-light.png"
                                     class="d-dark-mode-none position-relative rounded-4"
                                     style="top: 27.5%; max-width: 482px; box-shadow: 0 12px 48px -8px rgba(189, 196, 221, .35);"
                                     alt="Total users line chart">
                                <img src="/img/landing/saas-4/use-cases/data-analysis/line-chart-dark.png"
                                     class="d-none d-dark-mode-block position-relative rounded-4"
                                     style="top: 27.5%; max-width: 482px; box-shadow: 0 12px 48px -8px rgba(0, 0, 0, .25);"
                                     alt="Total users line chart">
                            </div>
                            <div class="parallax-layer" style="padding-left: 45.75%;" data-depth="-0.12">
                                <img src="/img/landing/saas-4/use-cases/data-analysis/bar-chart-light.png"
                                     class="d-dark-mode-none position-relative rounded-4"
                                     style="max-width: 345px; box-shadow: 0 0 48px -4px rgba(189, 196, 221, .35);"
                                     alt="Traffic bar chart">
                                <img src="/img/landing/saas-4/use-cases/data-analysis/bar-chart-dark.png"
                                     class="d-none d-dark-mode-block position-relative rounded-4"
                                     style="max-width: 345px; box-shadow: 0 12px 48px -8px rgba(0, 0, 0, .35);"
                                     alt="Traffic bar chart">
                            </div>
                            <div class="parallax-layer" style="padding-right: 7.547%; padding-left: 44.97%;"
                                 data-depth="0.3">
                                <img src="/img/landing/saas-4/use-cases/data-analysis/donut-chart-light.png"
                                     class="d-dark-mode-none position-relative rounded-4"
                                     style="top: 60.75%; max-width: 302px; box-shadow: 0 0 48px -4px rgba(189, 196, 221, .35);"
                                     alt="Traffic donut chart">
                                <img src="/img/landing/saas-4/use-cases/data-analysis/donut-chart-dark.png"
                                     class="d-none d-dark-mode-block position-relative rounded-4"
                                     style="top: 60.75%; max-width: 302px; box-shadow: 0 -12px 48px -8px rgba(0, 0, 0, .35);"
                                     alt="Traffic donut chart">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5 col-xl-4 offset-xl-1 order-md-1 text-center text-md-start">
                        ...
                        <p class="fs-lg pb-lg-2 mb-4">From complex analysis to stunning visualizations, our advanced AI
                            technology can help you extract valuable insights and make data-driven decisions faster than
                            ever before.</p>
                ...
                <div
                    ...
                    <div class="col-11 col-sm-9 col-md-7 col-lg-6 pb-2 pb-sm-3 pb-md-0 mb-4 mb-md-0">
                        <div class="parallax" style="max-width: 636px;">
                            <div class="parallax-layer" data-depth="0.05">
                                <img src="/img/landing/saas-4/use-cases/task-automation/circle-1.png"
                                     alt="Circle 1">
                            </div>
                            <div class="parallax-layer" data-depth="0.1">
                                <img src="/img/landing/saas-4/use-cases/task-automation/circle-2.png"
                                     alt="Circle 2">
                            </div>
                            <div class="parallax-layer" data-depth="0.15">
                                <img src="/img/landing/saas-4/use-cases/task-automation/circle-3.png"
                                     alt="Circle 3">
                            </div>
                            <div class="parallax-layer" data-depth="0.2">
                                <div
                                    class="position-absolute top-50 start-50 translate-middle bg-primary rounded-circle p-4">
                                    <div class="h1 text-white lh-1 p-sm-1 p-lg-3 m-1">AI</div>
                                </div>
                            </div>
                            <div class="parallax-layer" style="padding-right: 28.7%; padding-left: 57%;"
                                 data-depth="0.3">
                                <div class="position-relative">
                                    <div class="ratio ratio-1x1"></div>
                                    <span
                                        class="position-absolute top-0 start-0 w-100 h-100 bg-white rounded-circle d-dark-mode-none"
                                        style="box-shadow: 0 12px 48px -8px rgba(189, 196, 221, .35);"></span>
                                    <span
                                        class="position-absolute top-0 start-0 w-100 h-100 rounded-circle d-none d-dark-mode-block"
                                        style="background-color: #1c2126;"></span>
                                    <svg class="position-absolute top-0 start-0 z-2 text-dark" viewBox="0 0 92 91"
                            ...
                            <div class="parallax-layer" style="padding-right: 60%; padding-left: 27.6%;"
                                 data-depth="0.45">
                                <div class="position-relative" style="top: 13.3%;">
                                    ...
                                    <span
                                        class="position-absolute top-0 start-0 w-100 h-100 rounded-circle d-none d-dark-mode-block"
                                        style="background-color: #1c2126;"></span>
                                    <svg class="position-absolute top-0 start-0 z-2" viewBox="0 0 80 80"
                            ...
                            <div class="parallax-layer" style="padding-right: 85.8%;" data-depth="0.3">
                                <div class="position-relative" style="top: 32.7%;">
                                    ...
                                    <span
                                        class="position-absolute top-0 start-0 w-100 h-100 rounded-circle d-none d-dark-mode-block"
                                        style="background-color: #1c2126;"></span>
                                    <svg class="position-absolute top-0 start-0 z-2" viewBox="0 0 92 92"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#D)">
                                            <path
                                            ...
                                            <path
                                                ...
                                                fill="url(#B)"/>
                                            <path d="M58.577 35.749a2.4 2.4 0 0 1-4.8 0 2.4 2.4 0 1 1 4.8 0z"
                                                  fill="url(#C)"/>
                                        </g>
                                        <defs>
                                            ...
                                            <clipPath id="D">
                                                <path fill="#fff" transform="translate(25.501 26.425)"
                                                      d="M0 0h40v40H0z"/>
                                            </clipPath>
                                        </defs>
                                    </svg>
                            ...
                            <div class="parallax-layer" style="padding-right: 27.8%; padding-left: 62.9%;"
                                 data-depth="0.35">
                                <div class="position-relative" style="top: 30.7%;">
                                    ...
                                    <span
                                        class="position-absolute top-0 start-0 w-100 h-100 rounded-circle d-none d-dark-mode-block"
                                        style="background-color: #1c2126;"></span>
                                    <svg class="position-absolute top-0 start-0 z-2" viewBox="0 0 62 62" fill="#03a9f4"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <div class="parallax-layer" style="padding-right: 45%; padding-left: 45%;"
                                 data-depth="0.45">
                                <div class="position-relative" style="top: 73.5%;">
                                    ...
                                    <span
                                        class="position-absolute top-0 start-0 w-100 h-100 rounded-circle d-none d-dark-mode-block"
                                        style="background-color: #1c2126;"></span>
                                    <svg class="position-absolute top-0 start-0 z-2" viewBox="0 0 61 62" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <div class="parallax-layer" style="padding-right: 73.3%; padding-left: 11.1%;"
                                 data-depth="0.25">
                                <div class="position-relative" style="top: 78.8%;">
                                    ...
                                    <span
                                        class="position-absolute top-0 start-0 w-100 h-100 rounded-circle d-none d-dark-mode-block"
                                        style="background-color: #1c2126;"></span>
                                    <svg class="position-absolute top-0 start-0 z-2" viewBox="0 0 102 102" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <div class="parallax-layer" style="padding-right: 68.2%; padding-left: 21%;"
                                 data-depth="0.4">
                                <div class="position-relative" style="top: 52.9%;">
                                    ...
                                    <span
                                        class="position-absolute top-0 start-0 w-100 h-100 rounded-circle d-none d-dark-mode-block"
                                        style="background-color: #1c2126;"></span>
                                    <svg class="position-absolute top-0 start-0 z-2" viewBox="0 0 72 71"
                                        ...
                                        <path
                                            d="M27.8237 44.0212L35.8237 38.926L43.8237 44.0212L35.8237 49.1164L27.8237 44.0212Z"/>
                                        <path
                            ...
                            <div class="parallax-layer" style="padding-right: 16%; padding-left: 71.4%;"
                                 data-depth="0.3">
                                <div class="position-relative" style="top: 67.6%;">
                                    ...
                                    <span
                                        class="position-absolute top-0 start-0 w-100 h-100 rounded-circle d-none d-dark-mode-block"
                                        style="background-color: #1c2126;"></span>
                                    <svg class="position-absolute top-0 start-0 z-2" viewBox="0 0 82 81" fill="#5865f2"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path
                    ...
                    <div class="col-md-5 col-xl-4 offset-lg-1 text-center text-md-start">
                        ...
                        <p class="fs-lg pb-lg-2 mb-4">Integrate our smart AI with the tools you already know and use.
                            10x times increase your productivity and efficiency of your team.</p>
                        <a href="#" class="btn btn-outline-primary rounded-pill">
                            Learn more
                            <i class="ai-arrow-right fs-lg ms-2 me-n1"></i>
                        </a>
                ...
                <div class="row align-items-center justify-content-center py-4 py-md-5 my-2 my-sm-3 my-md-0 my-xl-3">
                    <div
                        ...
                        <div class="parallax" style="max-width: 636px;">
                            <div class="parallax-layer" data-depth="0.1">
                                <img src="/img/landing/saas-4/use-cases/chat-bot/window-light.png"
                                     class="d-dark-mode-none rounded-4"
                                     style="box-shadow: 0 10.2px 41px -6.8px rgba(189, 196, 221, .30);"
                                     alt="Chat bot UI window">
                                <img src="/img/landing/saas-4/use-cases/chat-bot/window-dark.png"
                                     class="d-none d-dark-mode-block rounded-4"
                                     style="box-shadow: 0 10.2px 41px -6.8px rgba(0, 0, 0, .20);"
                                     alt="Chat bot UI window">
                            </div>
                            <div class="parallax-layer" data-depth="0.15">
                                <img src="/img/landing/saas-4/use-cases/chat-bot/message1-light.png"
                                     class="d-dark-mode-none" alt="Message">
                                <img src="/img/landing/saas-4/use-cases/chat-bot/message1-dark.png"
                                     class="d-none d-dark-mode-block" alt="Message">
                            </div>
                            <div class="parallax-layer" data-depth="0.25">
                                <img src="/img/landing/saas-4/use-cases/chat-bot/message2-light.png"
                                     class="d-dark-mode-none" alt="Message">
                                <img src="/img/landing/saas-4/use-cases/chat-bot/message2-dark.png"
                                     class="d-none d-dark-mode-block" alt="Message">
                            </div>
                            <div class="parallax-layer" data-depth="0.35">
                                <img src="/img/landing/saas-4/use-cases/chat-bot/message3-light.png"
                                     class="d-dark-mode-none" alt="Message">
                                <img src="/img/landing/saas-4/use-cases/chat-bot/message3-dark.png"
                                     class="d-none d-dark-mode-block" alt="Message">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5 col-xl-4 offset-xl-1 order-md-1 text-center text-md-start">
                        ...
                        <p class="fs-lg pb-lg-2 mb-4">Seamlessly integrate natural language processing and machine
                            learning capabilities into your chat bot and provide a personalized experience to your end
                            users.</p>
                        <a href="#" class="btn btn-outline-primary rounded-pill">
                            Learn more
                            <i class="ai-arrow-right fs-lg ms-2 me-n1"></i>
                ...
                <!-- More button -->
                <div
                    class="d-flex flex-column flex-sm-row align-items-center justify-content-center gap-3 gap-sm-4 pt-4 pb-3 py-md-5 my-1 my-sm-3 my-md-0 mt-xl-3 mb-xl-4">
        ...
        <section class="bg-dark py-5" data-bs-theme="dark">
            <div class="container pt-2 py-sm-3 py-md-4 py-lg-5 my-xxl-3">
                <div class="row pt-md-2 pt-lg-3 pt-xl-4 pb-lg-2 pb-xl-3">
                    <div class="col-md-6">
                        <h2 class="h1 pe-xxl-5 me-xl-4 mb-md-0">Our <span class="text-warning">data centers</span>
                            spread all over the world. Get access to the API from anywhere</h2>
                    </div>
                    <div class="col-md-6 col-xl-5 offset-xl-1">
                        <p class="text-body fs-xl mb-0">Our data centers are a key component of our global
                            infrastructure, providing reliable and scalable computing resources to customers around the
                            world. We offer a highly distributed and resilient platform that can support the most
                            demanding workloads.</p>
                    </div>
                </div>
                <div class="pt-5 mt-sm-2 mt-md-3 mt-lg-4 mt-xl-5">
                    <img src="/img/landing/saas-4/map.png" alt="Map">
                </div>
            </div>
        </section>
        ...
        <section class="position-relative py-5">
            <span class="position-absolute top-0 start-0 w-100 h-100 d-dark-mode-none"
                  style="background: linear-gradient(360deg, #fff 5.39%, #f6f9fc 78.66%);"></span>
            <span class="position-absolute top-0 start-0 w-100 h-100 d-none d-dark-mode-block"
                  style="background: linear-gradient(360deg, #121519 5.39%, rgba(255, 255, 255, .03) 78.66%);"></span>
            <div class="container position-relative z-2 py-2 py-sm-3 py-sm-4 py-md-5">
                <div class="row align-items-center py-lg-2 py-xl-3 my-xl-1 my-xxl-3">
                    <div class="col-md-5 col-xl-4">
                        <h2 class="h1 pb-2 pb-sm-3 mb-md-0">Learn <span
                                class="text-gradient-primary">how Around works</span> in a nutshell. Watch a short
                            introductory video</h2>
                    </div>
                    <div class="col-md-7 offset-xl-1">
                        <div class="position-relative">
                            <div
                                class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center z-5">
                                <a href="https://www.youtube.com/watch?v=ADpOLD2z1Ns"
                                   class="btn btn-icon btn-xl btn-primary rounded-circle stretched-link"
                                   data-bs-toggle="video" aria-label="Play video">
                                    <i class="ai-play-filled"></i>
                                </a>
                            </div>
                            <img src="/img/landing/saas-4/video-cover-light.jpg"
                                 class="d-dark-mode-none rounded-3" alt="Video cover">
                            <img src="/img/landing/saas-4/video-cover-dark.png"
                                 class="d-none d-dark-mode-block rounded-3" alt="Video cover">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="position-relative pt-2 pt-sm-0 pt-md-2 pt-lg-3 pt-xl-4 pb-lg-4">
            <div class="container pb-2">
                ...
                <p class="fs-lg text-center pb-4 pb-lg-5 mb-2 mb-sm-3 mb-xl-4">Learn why top companies from around the
                    globe choose us</p>
                <div class="masonry-grid row row-cols-1 row-cols-sm-2 row-cols-lg-3 g-4 g-sm-3 g-md-4">
                    ...
                    <div class="masonry-grid-item col">
                        <div class="card border-0 bg-secondary p-1 p-sm-0 p-md-2">
                            <img src="/img/landing/saas-4/integrations/envato-light.svg"
                                 class="d-block d-dark-mode-none mx-auto" width="165" alt="Envato">
                            <img src="/img/landing/saas-4/integrations/envato-dark.svg"
                                 class="d-none d-dark-mode-block mx-auto" width="165" alt="Envato">
                            <div class="card-body text-center pt-1">
                                <p class="pb-3 mb-3">Streamline your workflow and save valuable time with this SaaS
                                    platform's powerful AI models, which takes care of the heavy lifting and delivers
                                    top-notch results.</p>
                                <img src="/img/avatar/50.jpg" class="d-inline-block rounded-circle" width="80"
                                     alt="Avatar">
                                <div class="pt-2 mt-1">
                                    <h3 class="h5 mb-1">Emma Johnson</h3>
                                    <p class="fs-sm text-body-secondary mb-0">CEO, Co-Founder</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="masonry-grid-item col">
                        <div class="card border-0 bg-secondary p-1 p-sm-0 p-md-2">
                            <img src="/img/landing/saas-4/integrations/firefox-light.svg"
                                 class="d-block d-dark-mode-none mx-auto" width="165" alt="Firefox">
                            <img src="/img/landing/saas-4/integrations/firefox-dark.svg"
                                 class="d-none d-dark-mode-block mx-auto" width="165" alt="Firefox">
                            <div class="card-body text-center pt-1">
                                <p class="pb-3 mb-3">Transform your business with this SaaS platform's outstanding AI
                                    models API, which delivers unparalleled efficiency, great service, and outstanding
                                    results.</p>
                                <div class="pt-2 mt-1">
                                    <h3 class="h5 mb-1">Robert Thompson</h3>
                                    <p class="fs-sm text-body-secondary mb-0">Chief Information Officer</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="masonry-grid-item col">
                        <div class="card border-0 bg-secondary p-1 p-sm-0 p-md-2">
                            <img src="/img/landing/saas-4/integrations/magento-light.svg"
                                 class="d-block d-dark-mode-none mx-auto" width="165" alt="Magento">
                            <img src="/img/landing/saas-4/integrations/magento-dark.svg"
                                 class="d-none d-dark-mode-block mx-auto" width="165" alt="Magento">
                            <div class="card-body text-center pt-1">
                                <p class="pb-3 mb-3">Differentiate your app from the competition with this SaaS
                                    platform's outstanding performance and exceptional API for implementing AI models
                                    into your application.</p>
                                <img src="/img/avatar/51.jpg" class="d-inline-block rounded-circle" width="80"
                                     alt="Avatar">
                                <div class="pt-2 mt-1">
                    ...
                    <div class="masonry-grid-item col">
                        <div class="card border-0 bg-secondary p-1 p-sm-0 p-md-2">
                            <img src="/img/landing/saas-4/integrations/pingdom-light.svg"
                                 class="d-block d-dark-mode-none mx-auto" width="165" alt="Pingdom">
                            <img src="/img/landing/saas-4/integrations/pingdom-dark.svg"
                                 class="d-none d-dark-mode-block mx-auto" width="165" alt="Pingdom">
                            <div class="card-body text-center pt-1">
                                <p class="pb-3 mb-3">Experience game-changing AI models that are accessible and
                                    user-friendly, thanks to this exceptional SaaS platform that offers an API for
                                    seamless integration.</p>
                                <img src="/img/avatar/52.jpg" class="d-inline-block rounded-circle" width="80"
                                     alt="Avatar">
                                <div class="pt-2 mt-1">
                                    <h3 class="h5 mb-1">Samantha Grace</h3>
                                    <p class="fs-sm text-body-secondary mb-0">Data Analyst</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="masonry-grid-item col">
                        <div class="card border-0 bg-secondary p-1 p-sm-0 p-md-2">
                            <img src="/img/landing/saas-4/integrations/woocommerce-light.svg"
                                 class="d-block d-dark-mode-none mx-auto" width="165" alt="WooCommerce">
                            <img src="/img/landing/saas-4/integrations/woocommerce-dark.svg"
                                 class="d-none d-dark-mode-block mx-auto" width="165" alt="WooCommerce">
                            <div class="card-body text-center pt-1">
                                <p class="pb-3 mb-3">This SaaS platform offers an API for integrating AI models into
                                    your app with ease, delivering impressive results and enabling you to take your
                                    business to the next level.</p>
                                <div class="pt-2 mt-1">
                                    <h3 class="h5 mb-1">William Matthews</h3>
                                    <p class="fs-sm text-body-secondary mb-0">Software Developer</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="masonry-grid-item col">
                        <div class="card border-0 bg-secondary p-1 p-sm-0 p-md-2">
                            <img src="/img/landing/saas-4/integrations/shopify-light.svg"
                                 class="d-block d-dark-mode-none mx-auto" width="165" alt="Shopify">
                            <img src="/img/landing/saas-4/integrations/shopify-dark.svg"
                                 class="d-none d-dark-mode-block mx-auto" width="165" alt="Shopify">
                            <div class="card-body text-center pt-1">
                                <p class="pb-3 mb-3">Get ahead of the competition with this SaaS platform's AI models
                                    API, which effortlessly automates processes and delivers exceptional service to
                                    ensure your success.</p>
                                <div class="pt-2 mt-1">
                                    <h3 class="h5 mb-1">Olivia Rodriguez</h3>
                                    <p class="fs-sm text-body-secondary mb-0">Human Resources</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="masonry-grid-item col">
                        <div class="card border-0 bg-secondary p-1 p-sm-0 p-md-2">
                            <img src="/img/landing/saas-4/integrations/laravel.svg" class="d-block mx-auto"
                                 width="165" alt="Laravel">
                            <div class="card-body text-center pt-1">
                                <p class="pb-3 mb-3">Implementing AI models has never been easier or more reliable,
                                    thanks to this SaaS platform's seamless API integration and accurate, dependable
                                    results.</p>
                                <div class="pt-2 mt-1">
                                    <h3 class="h5 mb-1">Benjamin Smith</h3>
                                    <p class="fs-sm text-body-secondary mb-0">Project Manager</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="masonry-grid-item col">
                        <div class="card border-0 bg-secondary p-1 p-sm-0 p-md-2">
                            <img src="/img/landing/saas-4/integrations/vite-light.svg"
                                 class="d-block d-dark-mode-none mx-auto" width="165" alt="Vite">
                            <img src="/img/landing/saas-4/integrations/vite-dark.svg"
                                 class="d-none d-dark-mode-block mx-auto" width="165" alt="Vite">
                            <div class="card-body text-center pt-1">
                                <p class="pb-3 mb-3">Stay ahead of the curve and leverage cutting-edge technology with
                                    this SaaS platform's unparalleled performance and impressive results.</p>
                                <div class="pt-2 mt-1">
                                    <h3 class="h5 mb-1">Abigail Collins</h3>
                                    <p class="fs-sm text-body-secondary mb-0">Chief Technology Officer</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="masonry-grid-item col">
                        <div class="card border-0 bg-secondary p-1 p-sm-0 p-md-2">
                            <img src="/img/landing/saas-4/integrations/angular-light.svg"
                                 class="d-block d-dark-mode-none mx-auto" width="165" alt="Angular">
                            <img src="/img/landing/saas-4/integrations/angular-dark.svg"
                                 class="d-none d-dark-mode-block mx-auto" width="165" alt="Angular">
                            <div class="card-body text-center pt-1">
                                <p class="pb-3 mb-3">Efficiently harness the power of AI models with this reliable and
                                    easy-to-use SaaS platform, featuring an API that provides excellent support and
                                    streamlines your processes.</p>
                                <div class="pt-2 mt-1">
                                    <h3 class="h5 mb-1">Elijah Brown</h3>
                                    <p class="fs-sm text-body-secondary mb-0">Project Manager</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="d-none d-md-block">
                <span class="position-absolute start-0 bottom-0 w-100 z-1 d-dark-mode-none"
                      style="height: 390px; background: linear-gradient(180deg, rgba(255, 255, 255, 0) 0%, #fff 50.14%);"></span>
                <span class="position-absolute start-0 bottom-0 w-100 z-2 d-none d-dark-mode-block"
                      style="height: 375px; background: linear-gradient(180deg, rgba(11, 15, 25, 0) 0%, #121519 50.14%);"></span>
            </div>
            <div class="d-md-none">
                <span class="position-absolute start-0 bottom-0 w-100 z-1 d-dark-mode-none"
                      style="height: 300px; background: linear-gradient(180deg, rgba(255, 255, 255, 0) 0%, #fff 50.14%);"></span>
                <span class="position-absolute start-0 bottom-0 w-100 z-2 d-none d-dark-mode-block"
                      style="height: 290px; background: linear-gradient(180deg, rgba(11, 15, 25, 0) 0%, #121519 50.14%);"></span>
            </div>

            <!-- More button -->
            <div
                class="position-absolute start-0 bottom-0 w-100 d-flex justify-content-center z-2 pb-5 px-3 mb-3 mb-md-4 mb-lg-5">
      ...
      ">
            <div class="jarallax position-absolute top-0 start-0 w-100 h-100" data-jarallax data-speed="0.4">
                <div class="jarallax-img"
                     style="background-image: url(/img/landing/saas-4/pricing-bg-pattern.png);"></div>
            </div>
            <div class="container position-relative z-2 pt-5" data-bs-theme="dark">
                <h2 class="h1 text-center pt-2 pt-sm-3 pb-4 pb-md-5 mb-2 mb-md-0 mb-lg-2">Around vs Custom
                    development</h2>
                ...
                <div class="position-relative ms-n4 ms-md-0 d-none d-md-block">
                    ...
                    <div class="row row-cols-3 align-items-center position-relative z-2 g-0">
                        ...
                        <div class="position-relative w-100 opacity-40">
                            <span class="position-absolute top-0 start-0 w-100"
                                  style="height: 1px; background: linear-gradient(270deg, #121519 0%, rgba(11, 15, 25, 0) 54.17%, #121519 98.44%);"></span>
                    ...
                    <div class="row row-cols-3 align-items-center position-relative z-2 g-0">
                        <div class="col py-3 py-md-4 ps-lg-5">
                            <div class="text-white opacity-80 fs-lg py-1 px-4 mx-auto" style="width: 208px;">Data Models
                                Infrastructure Cost
                            </div>
                        </div>
                    ...
                    <div class="row row-cols-3 align-items-center position-relative z-2 g-0">
                        <div class="col py-3 py-md-4 ps-lg-5">
                            <div class="text-white opacity-80 fs-lg py-1 px-4 mx-auto" style="width: 208px;">Engineering
                                Cost
                            </div>
                        </div>
                        <div class="col py-3 py-md-4">
                    ...
                    <div class="row row-cols-3 align-items-center position-relative z-2 g-0">
                        <div class="col py-3 py-md-4 ps-lg-5">
                            <div class="text-white opacity-80 fs-lg py-1 px-4 mx-auto" style="width: 208px;">Time to
                                Implement
                            </div>
                        </div>
                        <div class="col py-4">
                    ...
                    <div class="row row-cols-3 align-items-center position-relative z-2 g-0">
                        <div class="col py-3 py-md-4 ps-lg-5">
                            <div class="text-white opacity-80 fs-lg py-1 px-4 mx-auto" style="width: 208px;">Maintenance
                                &amp; Operational Cost
                            </div>
                        </div>
                        <div class="col py-3 py-md-4">
                ...
                <table class="table table-layout-fixed d-md-none" style="--ar-table-bg: transparent;">
                    ...
                    <tbody>
                    <tr>
                        <th scope="row" colspan="2" class="bg-secondary text-white text-center">Data Models
                            Infrastructure Cost
                        </th>
                    </tr>
                    <tr>
        ...
        <div class="container">
                  ...
                  <svg width="35" height="32" viewBox="0 0 36 33" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="d-flex flex-wrap flex-xl-column ps-xl-5 ms-n3 ms-xl-2">
                        <ul class="nav flex-xl-column">
                            ...
                            <li class="nav-item mb-1">
                                <a href="#" class="nav-link py-1 px-xl-0">Careers<span
                                        class="badge bg-danger bg-opacity-10 rounded-pill ms-2"><span
                                            class="text-danger">Hiring</span></span></a>
                            </li>
                            <li class="nav-item mb-1">
            ...
            <div class="text-sm-center pb-3 py-sm-3 py-md-4 py-xl-5">
                <p class="nav d-block fs-sm mb-0">
                    ...
                    <a class="nav-link d-inline-block p-0" href="" target="_blank"
