@extends('layouts.base', ['title' => 'Around UI Kit | Breadcrumb'])
...
<section class="container pt-5 pb-4">
  <div class="row pt-5 pb-2 pb-sm-3">
    <div class="col-lg-9 offset-lg-3 position-relative z-5">
      <h1 class="pt-lg-4">Breadcrumb</h1>
      <div class="d-flex flex-wrap flex-md-nowrap justify-content-between pb-3">
        <p class="text-body-secondary">Indicate the current page's location within a navigational hierarchy.</p>
        <p class="fs-sm fw-semibold ps-md-4">
          <a class="text-decoration-none text-nowrap" href="https://getbootstrap.com/docs/5.3/components/breadcrumb/" target="_blank" rel="noopener">
            Bootstrap docs
          ...
          <div class="tab-content">
            <div class="tab-pane fade show active" id="preview1" role="tabpanel">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item">
                    <a href="#" aria-label="Home"><i class="ai-home fs-base"></i></a>
                  </li>
                  <li class="breadcrumb-item"><a href="#">Products list</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Single product</li>
                </ol>
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item">
                    <a href="#"><i class="ai-home fs-base me-2"></i>Home</a>
                  </li>
                  <li class="breadcrumb-item"><a href="#">Products list</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Single product</li>
                </ol>
            ...
            <div class="tab-pane fade" id="html1" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Basic example --&gt;
&lt;nav aria-label=&quot;breadcrumb&quot;&gt;
  &lt;ol class=&quot;breadcrumb&quot;&gt;
    &lt;li class=&quot;breadcrumb-item&quot;&gt;&lt;a href=&quot;#&quot;&gt;Home&lt;/a&gt;&lt;/li&gt;
    &lt;li class=&quot;breadcrumb-item&quot;&gt;&lt;a href=&quot;#&quot;&gt;Products list&lt;/a&gt;&lt;/li&gt;
