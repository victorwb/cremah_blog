@extends('layouts.base', ['title' => 'Around | Marketing Agency'])
...
@section('content')
    ...
    <main class="page-wrapper">
                            ...
                            <div class="parallax-layer z-3" data-depth="0.1">
                                <div class="position-relative bg-dark mx-auto"
                                    ...
                                    <div class="position-absolute start-50 translate-middle-x"
                                        ...
                                        <div class="row row-cols-4 gx-2 mb-3">
                                            ...
                                            <div class="col position-relative">
                                                <div
                                                    class="position-absolute top-0 start-0 w-100 border-white border opacity-30"></div>
                                                <div
                                                    class="position-absolute top-0 start-0 w-50 border-white border opacity-80"></div>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <img class="rounded-circle"
                                                 src="/img/landing/marketing-agency/hero/avatar.jpg" width="35"
                                                 alt="Avatar">
                                    ...
                                    <video class="d-block w-100" autoplay loop muted
                                        ...
                                        <source src="/img/landing/marketing-agency/hero/video.mp4"
                                                type="video/mp4">
                                    </video>
                                </div>
                            </div>
                            <div class="parallax-layer" data-depth="0.3">
                                <img src="/img/landing/marketing-agency/hero/shape01.svg" alt="Background shape">
                            </div>
                            <div class="parallax-layer z-2" data-depth="-0.1">
                                <img src="/img/landing/marketing-agency/hero/shape02.svg" alt="Background shape">
                            </div>
                            <div class="parallax-layer" data-depth="-0.15">
                                <img src="/img/landing/marketing-agency/hero/shape03.svg" alt="Background shape">
                            </div>
                            <div class="parallax-layer z-2" data-depth="-0.25">
                                <img src="/img/landing/marketing-agency/hero/shape04.svg" alt="Background shape">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row row-cols-3 g-3 g-sm-4 g-lg-3 g-xl-4">
                            <div class="col">
                                <div class="bg-light rounded-3" data-aos="zoom-in" data-aos-easing="ease-out-back"
                                     data-aos-delay="300">
                                    <img src="/img/landing/marketing-agency/tools/bing.svg" alt="Bing">
                                </div>
                            </div>
                            <div class="col">
                                <div class="bg-light rounded-3" data-aos="zoom-in" data-aos-easing="ease-out-back"
                                     data-aos-delay="500">
                                    <img src="/img/landing/marketing-agency/tools/facebook.svg" alt="Facebook">
                                </div>
                            </div>
                            <div class="col">
                                <div class="bg-light rounded-3" data-aos="zoom-in" data-aos-easing="ease-out-back"
                                    ...
                                    <img class="d-dark-mode-none"
                                         src="/img/landing/marketing-agency/tools/microsoft-dark.svg"
                                         alt="Facebook">
                                    <img class="d-none d-dark-mode-block"
                                         src="/img/landing/marketing-agency/tools/microsoft-light.svg"
                                         alt="Facebook">
                                </div>
                            </div>
                            <div class="col">
                                <div class="bg-light rounded-3" data-aos="zoom-in" data-aos-easing="ease-out-back"
                                     data-aos-delay="800">
                                    <img src="/img/landing/marketing-agency/tools/google.svg" alt="Google">
                                </div>
                            </div>
                            <div class="col">
                                <div class="bg-light rounded-3" data-aos="zoom-in" data-aos-easing="ease-out-back">
                                    <img class="d-dark-mode-none"
                                         src="/img/landing/marketing-agency/tools/google-ads-dark.svg"
                                         alt="Google Ads">
                                    <img class="d-none d-dark-mode-block"
                                         src="/img/landing/marketing-agency/tools/google-ads-light.svg"
                                         alt="Google Ads">
                                </div>
                            </div>
                            <div class="col">
                                <div class="bg-light rounded-3" data-aos="zoom-in" data-aos-easing="ease-out-back"
                                     data-aos-delay="600">
                                    <img class="d-dark-mode-none"
                                         src="/img/landing/marketing-agency/tools/admitad-dark.svg" alt="Admitad">
                                    <img class="d-none d-dark-mode-block"
                                         src="/img/landing/marketing-agency/tools/admitad-light.svg"
                                         alt="Admitad">
                                </div>
                            </div>
                            <div class="col">
                                <div class="bg-light rounded-3" data-aos="zoom-in" data-aos-easing="ease-out-back"
                                     data-aos-delay="400">
                                    <img class="d-dark-mode-none"
                                         src="/img/landing/marketing-agency/tools/google-analytics-dark.svg"
                                         alt="Google Analytics">
                                    <img class="d-none d-dark-mode-block"
                                         src="/img/landing/marketing-agency/tools/google-analytics-light.svg"
                                         alt="Google Analytics">
                                </div>
                            </div>
                            <div class="col">
                                <div class="bg-light rounded-3" data-aos="zoom-in" data-aos-easing="ease-out-back"
                                     data-aos-delay="700">
                                    <img class="d-dark-mode-none"
                                         src="/img/landing/marketing-agency/tools/instagram-dark.svg"
                                         alt="Instagram">
                                    <img class="d-none d-dark-mode-block"
                                         src="/img/landing/marketing-agency/tools/instagram-light.svg"
                                         alt="Instagram">
                                </div>
                            </div>
                            <div class="col">
                                <div class="bg-light rounded-3" data-aos="zoom-in" data-aos-easing="ease-out-back"
                                     data-aos-delay="100">
                                    <img class="d-dark-mode-none"
                                         src="/img/landing/marketing-agency/tools/tiktok-dark.svg" alt="TikTok">
                                    <img class="d-none d-dark-mode-block"
                                         src="/img/landing/marketing-agency/tools/tiktok-light.svg" alt="TikTok">
                                </div>
                            </div>
                        </div>
        ...
        <section class="container py-5 my-lg-3 my-xl-4 my-xxl-5">
            ...
            <div
                class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 gy-4 gy-sm-5 gx-4 pb-3 pb-md-4 pb-lg-5 mb-md-3 mb-lg-0">
                ...
                <div class="col text-center">
                    ...
                    <p class="fs-sm mb-0">Pharetra morbi quis is massa maecenas vulputate elit non nullage a duis tortor
                        mi massa pharetra.</p>
                </div>
            ...
            <div class="container pb-sm-2 pb-md-3 pb-lg-5 mb-md-3 mb-lg-0">
                ...
                <div class="position-relative mx-auto" style="max-width: 1198px;">
                    <div class="position-relative z-3" data-aos="fade-left" data-aos-duration="600"
                         data-aos-offset="300">
                        <img src="/img/landing/marketing-agency/about/01.png" alt="Image">
                    </div>
                    <div class="position-absolute top-0 start-0 z-2" data-aos="fade-right" data-aos-duration="600"
                         data-aos-offset="300">
                        <img src="/img/landing/marketing-agency/about/02.png" alt="Image">
                    </div>
                    ...
                    <div class="col-md-6 col-xxl-5 offset-xxl-1 mb-4 mb-md-0">
                        <div class="text-center text-md-start pe-md-4 pe-xl-5 pe-xxl-0">
                            ...
                            <p class="fs-lg mb-2 mb-sm-3 mb-xl-4 mx-auto mx-md-0" style="max-width: 475px;">Sapien
                                ...
                                scelerisque viverra pharetra quis massa maecenas vulputate.</p>
                                ...
                                <div class="ratio ratio-21x9 position-relative mx-auto" style="max-width: 180px;">
                                    <div
                                        ...
                                        <img class="d-block d-dark-mode-none"
                                             src="/img/landing/saas-1/brands/klinos-gray.svg" width="120"
                                             alt="Klinos">
                                        <img class="d-none d-dark-mode-block"
                                             src="/img/landing/saas-1/brands/klinos-light.svg" width="120"
                                             alt="Klinos">
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="ratio ratio-21x9 position-relative mx-auto" style="max-width: 180px;">
                                    <div
                                        class="d-flex align-items-center justify-content-center position-absolute top-0 start-0 w-100 h-100 px-3">
                                        <img class="d-block d-dark-mode-none"
                                             src="/img/landing/saas-1/brands/starcraft-gray.svg" width="147"
                                             alt="Starcraft">
                                        <img class="d-none d-dark-mode-block"
                                             src="/img/landing/saas-1/brands/starcraft-light.svg" width="147"
                                             alt="Starcraft">
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="ratio ratio-21x9 position-relative mx-auto" style="max-width: 180px;">
                                    <div
                                        class="d-flex align-items-center justify-content-center position-absolute top-0 start-0 w-100 h-100 px-3">
                                        <img class="d-block d-dark-mode-none"
                                             src="/img/landing/saas-1/brands/airbnb-gray.svg" width="121"
                                             alt="Airbnb">
                                        <img class="d-none d-dark-mode-block"
                                             src="/img/landing/saas-1/brands/airbnb-light.svg" width="121"
                                             alt="Airbnb">
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="ratio ratio-21x9 position-relative mx-auto" style="max-width: 180px;">
                                    <div
                                        class="d-flex align-items-center justify-content-center position-absolute top-0 start-0 w-100 h-100 px-3">
                                        <img class="d-block d-dark-mode-none"
                                             src="/img/landing/saas-1/brands/alpine-gray.svg" width="132"
                                             alt="Alpine">
                                        <img class="d-none d-dark-mode-block"
                                             src="/img/landing/saas-1/brands/alpine-light.svg" width="132"
                                             alt="Alpine">
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="ratio ratio-21x9 position-relative mx-auto" style="max-width: 180px;">
                                    <div
                                        class="d-flex align-items-center justify-content-center position-absolute top-0 start-0 w-100 h-100 px-3">
                                        <img class="d-block d-dark-mode-none"
                                             src="/img/landing/saas-1/brands/foster-gray.svg" width="132"
                                             alt="Foster">
                                        <img class="d-none d-dark-mode-block"
                                             src="/img/landing/saas-1/brands/foster-light.svg" width="132"
                                             alt="Foster">
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="ratio ratio-21x9 position-relative mx-auto" style="max-width: 180px;">
                                    <div
                                        class="d-flex align-items-center justify-content-center position-absolute top-0 start-0 w-100 h-100 px-3">
                                        <img class="d-block d-dark-mode-none"
                                             src="/img/landing/saas-1/brands/champion-gray.svg" width="130"
                                             alt="Champion">
                                        <img class="d-none d-dark-mode-block"
                                             src="/img/landing/saas-1/brands/champion-light.svg" width="130"
                                             alt="Champion">
                                    </div>
                                </div>
                            </div>
        ...
        <section class="container">
            <div class="card border-0 bg-primary bg-opacity-10 position-relative overflow-hidden">
                <svg class="d-block position-absolute top-0 start-0 text-white text-dark-mode-dark" width="125"
                    ...
                    <path
                        d="M31.449 24.407c-3.548 2.915-5.337 11.454-3.766 16.243 2.021 6.166 4.77 4.409 10.194 5.258 9.962 1.567 16.666 6.796 24.475-2.666 8.725-10.56 1.251-23.538-11.605-23.142-5.831.176-17.756 3.676-19.298 4.306z"></path>
                </svg>
                        ...
                        <div class="col-md-4 col-lg-3 offset-lg-1 mb-3 mb-md-0">
                            ...
                            <div class="binded-content">
                                ...
                                <div class="binded-item active" id="author1">
                                    <img class="d-block rounded-circle mb-3" src="/img/avatar/13.jpg" width="86"
                                ...
                                <div class="binded-item" id="author2">
                                    <img class="d-block rounded-circle mb-3" src="/img/avatar/14.jpg" width="86"
                                         alt="Darell Steward">
                ...
                <div class="col-md-6 position-relative pb-3 pb-md-0 mb-2 mb-sm-3 mb-md-0">
                    ...
                    <div class="binded-content z-2">
                        ...
                        <div class="binded-item active" id="image1">
                            <img class="d-block rounded-5" src="/img/landing/marketing-agency/case-studies/01.jpg"
                                 alt="Image">
                        </div>

                        <!-- Item -->
                        <div class="binded-item" id="image2">
                            <img class="d-block rounded-5" src="/img/landing/marketing-agency/case-studies/02.jpg"
                                 alt="Image">
                        </div>

                        <!-- Item -->
                        <div class="binded-item" id="image3">
                            <img class="d-block rounded-5" src="/img/landing/marketing-agency/case-studies/03.jpg"
                                 alt="Image">
                        </div>
                    </div>
                </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide pb-1" data-swiper-binded="#image2">
                                    ...
                                    <p class="pb-3 mb-3 mb-xl-4">Pharetra in morbi quis is massa maecenas arcu vulputate
                                        ...
                                        pulvinar elit vulputate scelerisque.</p>
                                    <div
                                        class="d-flex d-md-none d-lg-flex justify-content-between w-100 pb-4 pb-xl-5 mb-2 mb-sm-3 mb-xl-2"
                                        style="max-width: 440px;">
                                        <div class="pe-4">
        ...
        <section class="position-relative pt-5 mt-lg-3 mt-xl-4 mt-xxl-5">
            ...
            <div
                class="container position-relative z-2 pb-3 pt-2 pt-sm-3 pt-md-4 pt-lg-5 mt-md-3 mt-xxl-2 mb-3 mb-lg-4">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide w-auto">
                            <div class="card-hover text-center" style="max-width: 306px;">
                                <img class="d-block rounded-5 mb-4" src="/img/landing/creative-agency/team/02.jpg"
                                     alt="Image">
                        ...
                        <div class="swiper-slide w-auto">
                            <div class="card-hover text-center" style="max-width: 306px;">
                                <img class="d-block rounded-5 mb-4" src="/img/landing/creative-agency/team/01.jpg"
                                     alt="Image">
                        ...
                        <div class="swiper-slide w-auto">
                            <div class="card-hover text-center" style="max-width: 306px;">
                                <img class="d-block rounded-5 mb-4" src="/img/landing/creative-agency/team/06.jpg"
                                     alt="Image">
                        ...
                        <div class="swiper-slide w-auto">
                            <div class="card-hover text-center" style="max-width: 306px;">
                                <img class="d-block rounded-5 mb-4" src="/img/landing/creative-agency/team/04.jpg"
                                     alt="Image">
                        ...
                        <div class="swiper-slide w-auto">
                            <div class="card-hover text-center" style="max-width: 306px;">
                                <img class="d-block rounded-5 mb-4" src="/img/landing/creative-agency/team/03.jpg"
                                     alt="Image">
                        ...
                        <div class="swiper-slide w-auto">
                            <div class="card-hover text-center" style="max-width: 306px;">
                                <img class="d-block rounded-5 mb-4" src="/img/landing/creative-agency/team/05.jpg"
                                     alt="Image">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <article class="swiper-slide h-auto">
                            <div class="card border-0 h-100">
                                ...
                                <div class="card-footer pt-3">
                                    <a class="d-flex align-items-center text-decoration-none pb-2" href="#">
                                        <img class="rounded-circle" src="/img/avatar/07.jpg" width="48"
                                             alt="Post author">
