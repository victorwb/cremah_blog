@extends('layouts.base', ['title' => 'Around UI Kit | Accordion'])
    ...
    <aside class="container position-fixed d-none d-lg-block start-50 translate-middle-x h-100 pt-5">
        <div class="row h-100 pt-5">
            ...
            <span class="nav-link px-0 py-2 active">
              <i class="ai-circle-arrow-down fs-lg opacity-90 me-2"></i>Accordion</span>
                            <ul class="nav flex-column border-start ps-3 ms-2 mb-2">
                                <li class="nav-item">
                                    <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#accordion-default"
                                       data-scroll="data-scroll">Default style</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1"
                                       href="#accordion-alternative" data-scroll="data-scroll">Alternative style</a>
                                </li>
                            </ul>
                        </li>
        ...
        <span class="nav-link px-0 py-2 active">
          ...
          Accordion
                    ...
                    <ul class="nav flex-column border-start ps-3 ms-2 mb-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#accordion-alternative"
                               data-scroll="data-scroll">Alternative style</a>
                        </li>
                    </ul>
                </li>
    ...
    <section class="container pt-5 pb-4">
        <div class="row pt-5 pb-2 pb-sm-3">
            <div class="col-lg-9 offset-lg-3 position-relative z-5">
                <h1 class="pt-lg-4">Accordion</h1>
                <div class="d-flex flex-wrap flex-md-nowrap justify-content-between pb-3">
                    <p class="text-body-secondary">Vertically stacked list of headers that can be clicked to reveal or
                        hide content associated with them.</p>
                    <p class="fs-sm fw-semibold ps-md-4">
                        <a class="text-decoration-none text-nowrap"
                           href="https://getbootstrap.com/docs/5.3/components/accordion/" target="_blank"
                           rel="noopener">
                            Bootstrap docs
                ...
                <!-- Default style -->
                <section class="card border-0 mb-4" id="accordion-default">
                    <div class="card-body pb-0">
                        <h2 class="h4 mb-n2">Default style</h2>
                    </div>
                                ...
                                <div class="accordion" id="accordionDefault">
                                    <div class="accordion-item">
                                        ...
                                        <div class="accordion-collapse collapse show" id="collapseOne"
                                            ...
                                            <div class="accordion-body fs-sm">This is the first item's accordion body.
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div class="accordion-collapse collapse" id="collapseTwo"
                                            ...
                                            <div class="accordion-body fs-sm">This is the second item's accordion body.
                                                It is hidden by default, until the collapse plugin adds the appropriate
                                                classes that we use to style each element. These classes control the
                                                overall appearance, as well as the showing and hiding via CSS
                                                transitions. You can modify any of this with custom CSS or overriding
                                    ...
                                    <div class="accordion-item">
                                        <h3 class="accordion-header" id="headingThree">
                                            <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    aria-expanded="false" aria-controls="collapseThree">Accordion Item
                                                #3
                                            </button>
                                        </h3>
                                        <div class="accordion-collapse collapse" id="collapseThree"
                                             aria-labelledby="headingThree" data-bs-parent="#accordionDefault">
                                            <div class="accordion-body fs-sm">This is the third item's accordion body.
                                                It is hidden by default, until the collapse plugin adds the appropriate
                                                classes that we use to style each element. These classes control the
                                                overall appearance, as well as the showing and hiding via CSS
                                                transitions. You can modify any of this with custom CSS or overriding
              ...
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Default accordion --&gt;
&lt;div class=&quot;accordion&quot; id=&quot;accordionDefault&quot;&gt;
...
&lt;/div&gt;</code></pre>
                ...
                <!-- Alternative style -->
                <section class="card border-0 mb-4" id="accordion-alternative">
                    <div class="card-body pb-0">
                        <h2 class="h4 mb-n2">Alternative style</h2>
                    </div>
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs flex-nowrap align-items-center mb-n1" role="tablist">
                            <li class="nav-item me-3">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="preview2" role="tabpanel"
                                ...
                                <div class="accordion accordion-alt" id="accordionAlternative">
                                    <div class="accordion-item">
                                        <h3 class="accordion-header" id="headingOneAlt">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapseOneAlt" aria-expanded="true"
                                                    aria-controls="collapseOneAlt">Accordion Item #1
                                            </button>
                                        </h3>
                                        <div class="accordion-collapse collapse show" id="collapseOneAlt"
                                             aria-labelledby="headingOneAlt" data-bs-parent="#accordionAlternative">
                                    ...
                                    <div class="accordion-item">
                                        <h3 class="accordion-header" id="headingTwoAlt">
                                            <button class="accordion-button collapsed" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapseTwoAlt"
                                                    aria-expanded="false" aria-controls="collapseTwoAlt">Accordion Item
                                                #2
                                            </button>
                                        </h3>
                                        <div class="accordion-collapse collapse" id="collapseTwoAlt"
                                             aria-labelledby="headingTwoAlt" data-bs-parent="#accordionAlternative">
                                            <div class="accordion-body">This is the second item's accordion body. It is
                                                hidden by default, until the collapse plugin adds the appropriate
                                                classes that we use to style each element. These classes control the
                                                overall appearance, as well as the showing and hiding via CSS
                                                transitions. You can modify any of this with custom CSS or overriding
                                    ...
                                    <div class="accordion-item">
                                        <h3 class="accordion-header" id="headingThreeAlt">
                                            <button class="accordion-button collapsed" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapseThreeAlt"
                                                    aria-expanded="false" aria-controls="collapseThreeAlt">Accordion
                                                Item #3
                                            </button>
                                        </h3>
                                        <div class="accordion-collapse collapse" id="collapseThreeAlt"
                                             aria-labelledby="headingThreeAlt" data-bs-parent="#accordionAlternative">
                                            <div class="accordion-body">This is the third item's accordion body. It is
                                                hidden by default, until the collapse plugin adds the appropriate
                                                classes that we use to style each element. These classes control the
                                                overall appearance, as well as the showing and hiding via CSS
                                                transitions. You can modify any of this with custom CSS or overriding
              ...
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Alternative accordion --&gt;
&lt;div class=&quot;accordion accordion-alt&quot; id=&quot;accordionAlternative&quot;&gt;
