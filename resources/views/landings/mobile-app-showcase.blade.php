@extends('layouts.base', ['title' => 'Around | Mobile App Showcase'])
...
@section('content')
    ...
    <main class="page-wrapper">
        ...
        <section class="bg-secondary position-relative pt-lg-3 pt-xl-4 pt-xxl-5">
            <div class="bg-primary position-absolute start-0 bottom-0 w-100 d-none d-xl-block"
                 style="height: 920px;"></div>
            <div class="bg-primary position-absolute start-0 bottom-0 w-100 d-none d-lg-block d-xl-none"
                 style="height: 830px;"></div>
            <div class="bg-primary position-absolute start-0 bottom-0 w-100 d-lg-none d-xl-none"
                 style="height: 62%;"></div>
            <div class="bg-dark bg-opacity-10 rounded-circle position-absolute start-50 d-none d-lg-block"
                 style="bottom: 220px; width: 480px; height: 480px; margin-left: -240px;" data-aos="zoom-in"
                 data-aos-duration="700" data-aos-delay="200" data-aos-offset="300"></div>
            <div class="container position-relative z-5 mt-2 pt-5 pb-2 pb-sm-4 pb-lg-5">
                <h1 class="display-3 text-center mx-auto pt-5 my-2 my-sm-4" style="max-width: 680px;">The Best Platform
                    For Online Learning</h1>
                <svg class="d-block mx-auto text-primary" width="511" height="40" viewBox="0 0 511 40"
                ...
                <div class="row justify-content-center pt-3 pt-sm-4 pt-md-5 mt-sm-1">
                    <div class="col-8 col-lg-4 order-lg-2" style="margin-top: -105px;">
                        ...
                        <div class="position-lg-sticky top-0 mb-5 pb-sm-2 pb-xl-4" style="padding-top: 110px;">
                            <img class="d-block mx-auto" src="/img/landing/mobile-app-showcase/hero/screen02.png"
                                 width="322" alt="App screen">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-4 order-lg-1 overflow-hidden mt-lg-4 pt-xl-3">
                        ...
                        <img class="d-none d-lg-block rounded-4 ms-auto"
                             src="/img/landing/mobile-app-showcase/hero/screen01.png" width="297" alt="App screen"
                        ...
                        <div class="text-center text-sm-start mb-5 mx-auto mx-sm-0 pb-lg-2 pb-xl-4"
                             style="max-width: 340px;" data-aos="fade-right" data-aos-offset="300"
                            ...
                            <div class="d-table bg-dark bg-opacity-10 rounded-1 p-2 mx-auto mx-sm-0 mb-3 mb-lg-4">
                                <svg class="d-block m-1 text-warning" width="24" height="24" viewBox="0 0 24 24"
                                     fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <p class="text-white opacity-80 mb-0">Fusce lectus neque viverra risus lobortis adipiscing
                                integer pulvinar elementum. Lorem viverra tincidunt tortor pellentesque.</p>
                        </div>
                        <div class="text-center text-sm-start mb-5 mx-auto mx-sm-0 pb-lg-2 pb-xl-4"
                             style="max-width: 340px;" data-aos="fade-right" data-aos-delay="200" data-aos-offset="250"
                             data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
                            <div class="d-table bg-dark bg-opacity-10 rounded-1 p-2 mx-auto mx-sm-0 mb-3 mb-lg-4">
                                <svg class="d-block m-1 text-warning" width="24" height="24" viewBox="0 0 24 24"
                                     fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col-sm-6 col-lg-4 order-lg-3 overflow-hidden mt-lg-4 pt-xl-3">
                        ...
                        <!-- Right app screen -->
                        <img class="d-none d-lg-block rounded-4"
                             src="/img/landing/mobile-app-showcase/hero/screen03.png" width="297" alt="App screen"
                             style="box-shadow: 0 .9375rem 3rem -.5rem rgba(18,34,50, .05);">
                        ...
                        <div class="text-center text-sm-start mb-5 mx-auto me-sm-0 pb-lg-2 pb-xl-4"
                             style="max-width: 340px;" data-aos="fade-left" data-aos-offset="250" data-aos-delay="400"
                             data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
                            <div class="d-table bg-dark bg-opacity-10 rounded-1 p-2 mx-auto mx-sm-0 mb-3 mb-lg-4">
                                <svg class="d-block m-1 text-warning" width="24" height="24" viewBox="0 0 24 24"
                                     fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p class="text-white opacity-80 mb-0">Fermentum convallis mi posuere rutrum turpis duis
                                facilisis integer. Rhoncus in in sit tellus velit quis laoreet morbi orci sed.</p>
                        </div>
                        <div class="text-center text-sm-start mb-5 mx-auto me-sm-0 pb-lg-2 pb-xl-4"
                             style="max-width: 340px;" data-aos="fade-left" data-aos-offset="200" data-aos-delay="600"
                             data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
                            <div class="d-table bg-dark bg-opacity-10 rounded-1 p-2 mx-auto mx-sm-0 mb-3 mb-lg-4">
                                <svg class="d-block m-1 text-warning" width="24" height="24" viewBox="0 0 24 24"
                                     fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p class="text-white opacity-80 mb-0">Arcu nisl aliquet vel pellentesque. Vitae nibh leo,
                                facilisis laoreet metus, felis. Egestas id enim turpis tellus, nulla adipiscing.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row pt-2 pt-sm-3 pt-md-4 pt-lg-5 pb-xxl-2 mt-md-3 mt-lg-0">
                <div class="col-lg-5 mb-5 mb-lg-0">
                    <div class="h1 text-center text-lg-start pb-md-2 pb-xl-0 mb-4 mb-xl-5">Improve your skills and gain
                        knowledge in one application. Become the best version of yourself
                    </div>

                    <!-- Market buttons -->
                    <div class="d-flex justify-content-center justify-content-lg-start">
                        <a class="btn btn-dark btn-lg px-3 py-2 me-3" href="#">
                            <img class="d-dark-mode-none mx-1" src="/img/market/appstore-light.svg" width="136"
                                 alt="App Store">
                            <img class="d-none d-dark-mode-block mx-1" src="/img/market/appstore-dark.svg"
                                 width="136" alt="App Store">
                        </a>
                        <a class="btn btn-dark btn-lg px-3 py-2" href="#">
                            <img class="d-dark-mode-none mx-1" src="/img/market/googleplay-light.svg" width="135"
                                 alt="Google Play">
                            <img class="d-none d-dark-mode-block mx-1" src="/img/market/googleplay-dark.svg"
                ...
                <div class="col-md-6 pb-2 pb-sm-0 mb-4 mb-sm-5 mb-md-0">
                    ...
                    <div class="binded-content bg-primary rounded-5">
                        ...
                        <div class="binded-item active" id="image1">
                            <svg class="d-block position-absolute top-0 start-0 w-100 h-100 text-warning" width="636"
                                 height="640" viewBox="0 0 636 640" fill="currentColor"
                                ...
                                <path
                                    d="M140.2,52.6c-1.2-9-6.2-17.2-12-24c-0.8-0.9-2.1-1-3-0.2c-0.9,0.8-1,2.1-0.2,3c5.3,6.2,10,13.6,11,21.8c0.1,1.2,1.2,2,2.4,1.8C139.5,54.9,140.3,53.8,140.2,52.6z"></path>
                                <path
                                    d="M124.1,72.9c-6.1,0.3-11.5,2-17.2,3.6c-1.1,0.3-1.8,1.5-1.5,2.6c0.3,1.1,1.5,1.8,2.6,1.5c5.5-1.5,10.6-3.1,16.3-3.4c1.2-0.1,2.1-1,2-2.2C126.2,73.7,125.3,72.8,124.1,72.9z"></path>
                                <path
                                    d="M131.5,57.8c-11.4-6.8-25.1-12.4-38.2-15.2c-1.1-0.2-2.3,0.5-2.5,1.6c-0.2,1.1,0.5,2.3,1.6,2.5c12.6,2.8,25.9,8.1,36.9,14.7c1,0.6,2.3,0.3,2.9-0.7C132.8,59.7,132.5,58.4,131.5,57.8z"></path>
                            </svg>
                            <img class="d-block position-relative z-2"
                                 src="/img/landing/mobile-app-showcase/features/01.png" alt="App screen">
                        </div>
                        ...
                        <div class="binded-item" id="image2">
                            ...
                            <img class="d-block position-relative z-2"
                                 src="/img/landing/mobile-app-showcase/features/02.png" alt="App screen">
                        </div>
                        ...
                        <div class="binded-item" id="image3">
                            ...
                            <img class="d-block position-relative z-2"
                                 src="/img/landing/mobile-app-showcase/features/03.png" alt="App screen">
                        </div>
                    </div>
                </div>
                  ...
                  "nextEl": "#next-feature"
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide" data-swiper-binded="#image1">
                                    ...
                                    <p class="mb-0">Odio pellentesque faucibus tortor, sit ac mattis tincidunt magna
                                        sit. Vitae elementum amet etiam rhoncus, lacinia amet interdum pharetra
                                        tincidunt. Ultricies faucibus ac morbi eget nunc pretium id. Velit tristique
                                        scelerisque elit sociis convallis ultricies aliquam.</p>
                                </div>
                                ...
                                <div class="swiper-slide" data-swiper-binded="#image3">
                                    ...
                                    <h2 class="h1 mb-lg-4">Study with a teacher in video format at a time convenient for
                                        you</h2>
                                    <p class="mb-0">Odio pellentesque faucibus tortor, sit ac mattis tincidunt magna
                                        sit. Vitae elementum amet etiam rhoncus, lacinia amet interdum pharetra
                                        tincidunt. Ultricies faucibus ac morbi eget nunc pretium id. Velit tristique
                        ...
                        <div class="d-flex justify-content-center justify-content-md-start pt-4 mt-2 mt-lg-0 pt-lg-5">
                            <button class="btn btn-icon btn-outline-primary rounded-circle me-3" type="button"
        ...
        <section class="overflow-hidden pt-5 mt-lg-3 mt-xl-4 mt-xxl-5">
            <div class="container pt-3 pt-sm-4 pt-lg-5 mt-md-3 mt-lg-0">
                <div class="row align-items-center">
                    <div
                        class="col-md-7 col-xxl-6 offset-xl-1 offset-xxl-2 order-md-2 pb-2 pb-sm-0 mb-4 mb-sm-5 mb-md-0">
                        <div class="parallax mx-auto" style="max-width: 560px;">
                            <div class="parallax-layer" data-depth="0.1">
                                <img src="/img/landing/mobile-app-showcase/people/01.png" alt="Layer">
                            </div>
                            <div class="parallax-layer" data-depth="-0.05">
                                <img src="/img/landing/mobile-app-showcase/people/02.png" alt="Layer">
                            </div>
                            <div class="parallax-layer" data-depth="0.2">
                                <img src="/img/landing/mobile-app-showcase/people/03.png" alt="Layer">
                            </div>
                            <div class="parallax-layer" data-depth="-0.15">
                                <img src="/img/landing/mobile-app-showcase/people/04.png" alt="Layer">
                            </div>
                            <div class="parallax-layer" data-depth="0.25">
                                <img src="/img/landing/mobile-app-showcase/people/05.png" alt="Layer">
                            </div>
                            <div class="parallax-layer" data-depth="0.35">
                                <img src="/img/landing/mobile-app-showcase/people/06.png" alt="Layer">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5 col-xl-4 order-md-1">
                        <h2 class="h1 text-center text-md-start mb-4">Online learning has already been chosen by 5
                            million people</h2>
                        ...
                        <div class="d-flex justify-content-center justify-content-md-start gap-4">
                            <div>
                                <img class="d-dark-mode-none"
                                     src="/img/landing/mobile-app-showcase/awards/01-dark.png" width="188"
                                     alt="Award">
                                <img class="d-none d-dark-mode-block"
                                     src="/img/landing/mobile-app-showcase/awards/01-light.png" width="188"
                                     alt="Award">
                            </div>
                            <div>
                                <img class="d-dark-mode-none"
                                     src="/img/landing/mobile-app-showcase/awards/02-dark.png" width="188"
                                     alt="Award">
                                <img class="d-none d-dark-mode-block"
                                     src="/img/landing/mobile-app-showcase/awards/02-light.png" width="188"
                                     alt="Award">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide h-auto">
                        <div class="card border-0 bg-info bg-opacity-10 h-100 text-center">
                            <div class="polygon-avatar bg-info mx-auto translate-middle-y">
                                <img src="/img/landing/mobile-app-showcase/testimonials/01.png"
                                     alt="Nick Williams">
                            </div>
                            <div class="card-body pt-0 mt-n4">
                                <p class="card-text fs-xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc
                                    quis libero vitae sem ornare ornare. Aliquam ut sapien vitae quam blandit egestas.
                                    Quisque nulla elit, fermentum et tincidunt tempor, rutrum at leo. Curabitur massa
                                    quam, aliquam eu sapien sed.</p>
                            </div>
                    ...
                    <div class="swiper-slide h-auto">
                        <div class="card border-0 bg-warning bg-opacity-10 h-100 text-center">
                            <div class="polygon-avatar bg-warning mx-auto translate-middle-y">
                                <img src="/img/landing/mobile-app-showcase/testimonials/02.png"
                                     alt="Lili Bocouse">
                            </div>
                            <div class="card-body pt-0 mt-n4">
                                <p class="card-text fs-xl">Proin interdum purus non quam convallis, quis dignissim leo
                                    cursus. Praesent finibus elit nisl, sed ultrices elit lobortis in. Donec laoreet sit
                                    amet nulla quis hendrerit. Praesent venenatis mattis ante. Praesent justo elit,
                                    suscipit a libero sit amet, luctus posuere mi.</p>
                            </div>
                            <div class="card-footer border-0 pt-0">
                    ...
                    <div class="swiper-slide h-auto">
                        <div class="card border-0 bg-primary bg-opacity-10 h-100 text-center">
                            <div class="polygon-avatar bg-primary mx-auto translate-middle-y">
                                <img src="/img/landing/mobile-app-showcase/testimonials/04.png"
                                     alt="Esther Howard">
                            </div>
                            <div class="card-body pt-0 mt-n4">
                                <p class="card-text fs-xl">Viverra aliquam interdum mauris facilisi commodo euismod sit
                                    est. Et auctor diam a ac vitae vestibulum, eu. Tortor id aliquet rhoncus at orci et
                                    tempus, dictum turpis. Purus sit porta lacus, velit. Bibendum at nunc et, ac id
                                    vitae nibh semper in dignissim ac nascetur lorem et.</p>
                            </div>
                            <div class="card-footer border-0 pt-0">
                    ...
                    <div class="swiper-slide h-auto">
                        <div class="card border-0 bg-danger bg-opacity-10 h-100 text-center">
                            <div class="polygon-avatar bg-danger mx-auto translate-middle-y">
                                <img src="/img/landing/mobile-app-showcase/testimonials/03.png" alt="Jane Cooper">
                            </div>
                            <div class="card-body pt-0 mt-n4">
                                <p class="card-text fs-xl">Nam arcu ut in bibendum tincidunt quam massa vitae viverra
                                    sem eget. Felis morbi augue cras praesent arcu purus non id consequat dignissim
                                    sollicitudin tincidunt dui, dui felis ut ultricies vestibulum ipsum ullamcorper nunc
                                    at massa a aliquam massa lacus enim.</p>
                            </div>
                            <div class="card-footer border-0 pt-0">
            ...
            <div class="container py-md-2 py-lg-3 py-xl-5 my-2 my-sm-3 my-md-4 my-xxl-5">
                <div class="row">
                    <div class="col-md-4 text-center text-md-start">
                        ...
                        <p class="pb-3 pb-sm-4">Et felis vitae ac venenatis lacus cras etiam risus scelerisque auctor
                            adipiscing in a porta</p>
                        ...
                        <div class="accordion" id="faq">
                            <div class="accordion-item bg-light">
                                <h3 class="accordion-header" id="headingOne">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                            ...
                                            aria-controls="questionOne">Is there a free trial?
                                    </button>
                                </h3>
                                <div class="accordion-collapse collapse show" id="questionOne"
                                     aria-labelledby="headingOne" data-bs-parent="#faq">
                                    <div class="accordion-body fs-sm">Adipiscing sagittis neque egestas id platea
                                        accumsan. Morbi inpa platea urna curabitur habitant pulvinar lacinia neque.
                                        Netus gravida amet, aliquam quam turpis aliquet cras. Find aute irure dolor in
                                        reprehenderit voluptate velit esse cillum dolore eu nulla pariatur. Sit amet,
                                        adipiscing elit.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item bg-light">
                                <h3 class="accordion-header" id="headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#questionTwo" aria-expanded="false"
                                            aria-controls="questionTwo">How do refunds work?
                                    </button>
                                </h3>
                                <div class="accordion-collapse collapse" id="questionTwo" aria-labelledby="headingTwo"
                                     data-bs-parent="#faq">
                                    <div class="accordion-body fs-sm">Quisque rutrum sit amet magna sit amet tristique.
                            ...
                            <div class="accordion-item bg-light">
                                <h3 class="accordion-header" id="headingThree">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#questionThree" aria-expanded="false"
                                            aria-controls="questionThree">Do you offer student discounts?
                                    </button>
                                </h3>
                                <div class="accordion-collapse collapse" id="questionThree"
                                     aria-labelledby="headingThree" data-bs-parent="#faq">
                                    <div class="accordion-body fs-sm">Proin ac quam eget velit luctus tincidunt vel in
                                        nunc. Maecenas cursus erat lacus, id interdum elit accumsan in. Mauris placerat
                                        dapibus sem, condimentum interdum nulla varius ac. Mauris quam mauris, rhoncus
                                        et tortor vel, tempus dignissim libero. Curabitur sed odio in odio elementum
                                        cursus.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item bg-light">
                                <h3 class="accordion-header" id="headingFour">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#questionFour" aria-expanded="false"
                                            aria-controls="questionFour">What happens if I run out of credit?
                                    </button>
                                </h3>
                                <div class="accordion-collapse collapse" id="questionFour" aria-labelledby="headingFour"
                                     data-bs-parent="#faq">
                                    <div class="accordion-body fs-sm">Lorem ipsum dolor sit amet, consectetur adipiscing
                            ...
                            <div class="accordion-item bg-light">
                                <h3 class="accordion-header" id="headingFive">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#questionFive" aria-expanded="false"
                                            aria-controls="questionFive">Do you have monthly and yearly billing options?
                                    </button>
                                </h3>
                                <div class="accordion-collapse collapse" id="questionFive" aria-labelledby="headingFive"
                                     data-bs-parent="#faq">
                                    <div class="accordion-body fs-sm">Vestibulum faucibus lectus eget augue pharetra,
                                        ...
                                        lacinia orci. Phasellus at varius arcu. Ut nec lobortis velit.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item bg-light">
                                <h3 class="accordion-header" id="headingSix">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#questionSix" aria-expanded="false"
                                            aria-controls="questionSix">What happens when I change plans?
                                    </button>
                                </h3>
                                <div class="accordion-collapse collapse" id="questionSix" aria-labelledby="headingSix"
                                     data-bs-parent="#faq">
                                    <div class="accordion-body fs-sm">Nunc non placerat mi, sit amet hendrerit lacus.
                                        Quisque cursus lorem vitae placerat ultrices. Morbi ut orci sit amet quam
                                        vulputate lobortis. Donec vulputate mi nec nisi tincidunt commodo. Nullam
                                        efficitur tincidunt tellus accumsan pellentesque. Suspendisse elementum blandit
                                        orci.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item bg-light">
                                <h3 class="accordion-header" id="headingSeven">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            ...
                                            aria-controls="questionSeven">How do I cancel my paid plan?
                                    </button>
                                </h3>
                                <div class="accordion-collapse collapse" id="questionSeven"
                                     aria-labelledby="headingSeven" data-bs-parent="#faq">
                                    <div class="accordion-body fs-sm">Morbi a consequat diam. Fusce sit amet faucibus
                                        erat. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per
                                        inceptos himenaeos. Quisque id est dictum, suscipit neque id, ornare nibh. Cras
                                        lacinia, est non ultrices porttitor, arcu orci rhoncus leo, egestas condimentum
                                        lorem.
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="position-relative overflow-hidden rounded-5 px-4 px-sm-5 px-lg-0">
                    <div class="bg-primary rounded-5 position-absolute top-0 start-0 w-100 h-100" data-aos="zoom-in"
                         data-aos-duration="600" data-aos-offset="300" data-disable-parallax-down="lg"></div>
                    <div class="row align-items-center position-relative z-2">
                        <div class="col-md-6 col-lg-5 col-xl-4 offset-lg-1 pb-sm-3 pt-5 py-md-0 py-lg-5"
                             data-aos="fade-up" data-aos-duration="500" data-aos-offset="250"
                             data-disable-parallax-down="lg">
                            <h2 class="display-3 text-white text-center text-md-start mb-4 mb-lg-5">Ready to <br
                                    class="d-none d-xxl-inline">Get Started?</h2>
                            ...
                            <div class="d-flex flex-column flex-sm-row justify-content-center justify-content-md-start">
                                <a class="btn btn-light btn-lg px-3 py-2 me-sm-3 mb-3 mb-sm-0" href="#">
                                    <img class="mx-1" src="/img/market/appstore-dark.svg" width="136"
                                         alt="App Store">
                                </a>
                                <a class="btn btn-light btn-lg px-3 py-2" href="#">
                                    <img class="mx-1" src="/img/market/googleplay-dark.svg" width="135"
                                         alt="Google Play">
                                </a>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-5 offset-xl-1">
                            ...
                            <img class="d-block d-md-none mx-auto"
                                 src="/img/landing/mobile-app-showcase/features/03.png" width="420"
                                 alt="App screen">

                            <!-- Image visible on screens > 768px -->
                            <div class="d-none d-md-block position-relative mx-auto" style="max-width: 484px;">
                                <div class="position-absolute top-0 start-0 w-100 h-100" data-aos="zoom-in"
                                     data-aos-duration="400" data-aos-delay="600" data-aos-offset="300"
                                     data-aos-easing="ease-out-back" data-disable-parallax-down="lg">
                                    <svg class="text-warning position-absolute top-0 start-0 w-100 h-100" width="484"
                                         height="590" viewBox="0 0 484 590" fill="currentColor"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path
                                        ...
                                        <path
                                            d="M42.4929 62.8378C31.073 56.0023 17.3524 50.4482 4.32343 47.5959C3.18562 47.3476 2.05922 48.0685 1.81258 49.2044C1.56593 50.3402 2.28436 51.4658 3.42217 51.7141C16.0197 54.4726 29.2896 59.844 40.327 66.4552C41.3271 67.052 42.6231 66.7263 43.2192 65.7286C43.8152 64.7309 43.493 63.4346 42.4929 62.8378Z"></path>
                                        <path
                                            d="M51.1742 57.6399C50.0172 48.6073 44.9377 40.4608 39.1682 33.66C38.4115 32.7739 37.0807 32.6648 36.1979 33.4154C35.3087 34.1687 35.2011 35.4998 35.9511 36.3879C41.2085 42.5807 45.9377 49.949 46.9927 58.1754C47.1402 59.3297 48.1987 60.1459 49.3501 59.9984C50.5016 59.8517 51.3216 58.7935 51.1742 57.6399Z"></path>
                                    </svg>
                                </div>
                                <img src="/img/landing/mobile-app-showcase/cta-screens.png" alt="App screens"
