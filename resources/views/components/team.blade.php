@extends('layouts.base', ['title' => 'Around UI Kit | Team'])
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item" id="team">
            ...
            <ul class="nav flex-column border-start ps-3 ms-2 mb-2">
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#team-1" data-scroll="data-scroll">Style 1</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#team-2" data-scroll="data-scroll">Style 2</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#team-3" data-scroll="data-scroll">Style 3</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#team-4" data-scroll="data-scroll">Style 4</a>
              </li>
            </ul>
          </li>
...
<section class="container pt-5 pb-4">
  <div class="row pt-5 pb-2 pb-sm-3">
    <div class="col-lg-9 offset-lg-3 position-relative z-5">
      <h1 class="pt-lg-4">Team</h1>
      <div class="d-flex flex-wrap flex-md-nowrap justify-content-between pb-3">
        <p class="text-body-secondary">Component designed to showcase team members. Comes in different styles.</p>
      ...
      <!-- Style 1 -->
      <section class="card border-0 mb-4" id="team-1">
          ...
          <div class="tab-content">
            <div class="tab-pane fade show active" id="preview1" role="tabpanel">
              <div class="card-hover text-center" style="max-width: 306px;">
                <img class="d-block rounded-5 mb-4" src="/img/landing/creative-agency/team/02.jpg" alt="Image">
                ...
                <div class="d-none d-lg-flex nav justify-content-center opacity-0">
                  <a class="nav-link btn btn-icon btn-sm fs-sm fw-normal me-1" href="#" aria-label="Instagram">
            ...
            <div class="tab-pane fade" id="html1" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Team Style 1 --&gt;
&lt;div class=&quot;card-hover text-center&quot; style=&quot;max-width: 306px;&quot;&gt;
...
&lt;/div&gt;</code></pre>
      ...
      <!-- Style 2 -->
      <section class="card border-0 mb-4" id="team-2">
        <div class="card-body pb-0">
        ...
        <div class="card-body">
          <div class="tab-content">
            ...
            <div class="tab-pane fade" id="html2" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Team Style 2 --&gt;
&lt;div class=&quot;card card-hover border-0 rounded-5 overflow-hidden&quot; style=&quot;max-width: 416px;&quot;&gt;
...
&lt;/div&gt;</code></pre>
      ...
      <!-- Style 3 -->
      <section class="card border-0 mb-4" id="team-3">
        <div class="card-body pb-0">
          <h2 class="h4 mb-n2">Style 3</h2>
        </div>
        <div class="card-header">
          <ul class="nav nav-tabs card-header-tabs flex-nowrap align-items-center mb-n1" role="tablist">
            <li class="nav-item me-3">
        ...
        <div class="card-body">
          <div class="tab-content">
              ...
              <div class="card-hover pb-3" style="max-width: 396px;">
                <div class="position-relative">
                  ...
                  <div class="d-flex justify-content-center position-absolute start-0 bottom-0 w-100 px-3 mb-4 opacity-0">
                    <a class="btn btn-light btn-icon btn-sm btn-facebook rounded-circle mx-2" href="#" aria-label="Facebook">
                      <i class="ai-facebook"></i>
                    </a>
                    <a class="btn btn-light btn-icon btn-sm btn-x rounded-circle mx-2" href="#" aria-label="X">
                      <i class="ai-x"></i>
                    </a>
                    <a class="btn btn-light btn-icon btn-sm btn-behance rounded-circle mx-2" href="#" aria-label="Behance">
            ...
            <div class="tab-pane fade" id="html3" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Team Style 3 --&gt;
&lt;div class=&quot;card-hover pb-3&quot; style=&quot;max-width: 396px;&quot;&gt;
  &lt;div class=&quot;position-relative&quot;&gt;
...
&lt;/div&gt;</code></pre>
      ...
      <!-- Style 4 -->
      <section class="card border-0 mb-4" id="team-4">
        <div class="card-body pb-0">
          <h2 class="h4 mb-n2">Style 4</h2>
        </div>
        <div class="card-header">
          <ul class="nav nav-tabs card-header-tabs flex-nowrap align-items-center mb-n1" role="tablist">
            <li class="nav-item me-3">
        ...
        <div class="card-body">
          <div class="tab-content">
            <div class="tab-pane fade show active" id="preview4" role="tabpanel">
              <a class="d-block card-hover text-decoration-none" href="#" style="max-width: 416px;">
                <div class="bg-secondary rounded-5 position-relative overflow-hidden">
                  <div class="position-absolute top-0 start-0 w-100 h-100 bg-size-cover bg-position-center opacity-0" style="background-image: url(/img/landing/blog/authors/hover.svg);"></div>
                  <img class="position-relative z-2" src="/img/landing/blog/authors/01.png" alt="Author picture">
                </div>
                <div class="border-bottom pt-4 pb-3">
            ...
            <div class="tab-pane fade" id="html4" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Team Style 4 --&gt;
