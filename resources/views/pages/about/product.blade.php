@extends('layouts.base', ['title' => 'Around | About - Product'])
        ...
        <div class="container position-relative z-2 pt-4 pt-sm-5 mt-2 mt-sm-0 mt-md-2 mt-lg-3 mt-xl-4 mt-xxl-5">
            ...
            <div class="parallax">
                <div class="parallax-layer" data-depth="-0.05">
                    <img class="d-dark-mode-none" src="/img/about/product/hero/01-light.png" alt="Layer">
                    <img class="d-none d-dark-mode-block" src="/img/about/product/hero/01-dark.png" alt="Layer">
                </div>
                <div class="parallax-layer" data-depth="0.1">
                    <img class="d-dark-mode-none" src="/img/about/product/hero/02-light.png" alt="Layer">
                    <img class="d-none d-dark-mode-block" src="/img/about/product/hero/02-dark.png" alt="Layer">
                </div>
                <div class="parallax-layer z-2" data-depth="0.2">
                    <img class="d-dark-mode-none" src="/img/about/product/hero/03-light.png" alt="Layer">
                    <img class="d-none d-dark-mode-block" src="/img/about/product/hero/03-dark.png" alt="Layer">
                </div>
                <div class="parallax-layer" data-depth="-0.2">
                    <img class="d-dark-mode-none" src="/img/about/product/hero/04-light.png" alt="Layer">
                    <img class="d-none d-dark-mode-block" src="/img/about/product/hero/04-dark.png" alt="Layer">
                </div>
                <div class="parallax-layer" data-depth="-0.25">
                    <img class="d-dark-mode-none" src="/img/about/product/hero/05-light.png" alt="Layer">
                    <img class="d-none d-dark-mode-block" src="/img/about/product/hero/05-dark.png" alt="Layer">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="row row-cols-3 row-cols-sm-4 row-cols-lg-5 row-cols-xl-6 justify-content-center align-items-center g-4">
            <div class="col text-center">
                <a class="swap-image my-1 my-sm-2" href="#">
                    <img class="swap-to" src="/img/landing/saas-1/brands/foster-color.svg" width="145" alt="Foster">
                    <div class="swap-from">
                        <img class="d-dark-mode-none" src="/img/landing/saas-1/brands/foster-gray.svg" width="145" alt="Foster">
                        <img class="d-none d-dark-mode-block" src="/img/landing/saas-1/brands/foster-light.svg" width="145" alt="Foster">
                    </div>
                </a>
            </div>
            <div class="col text-center">
                <a class="swap-image my-1 my-sm-2" href="#">
                    <img class="swap-to" src="/img/landing/saas-1/brands/klinos-color.svg" width="140" alt="Klinos">
                    <div class="swap-from">
                        <img class="d-dark-mode-none" src="/img/landing/saas-1/brands/klinos-gray.svg" width="140" alt="Klinos">
                        <img class="d-none d-dark-mode-block" src="/img/landing/saas-1/brands/klinos-light.svg" width="140" alt="Klinos">
                    </div>
                </a>
            </div>
            <div class="col text-center">
                <a class="swap-image my-1 my-sm-2" href="#">
                    <img class="swap-to" src="/img/landing/saas-1/brands/champion-color.svg" width="160" alt="Champion">
                    <div class="swap-from">
                        <img class="d-dark-mode-none" src="/img/landing/saas-1/brands/champion-gray.svg" width="160" alt="Champion">
                        <img class="d-none d-dark-mode-block" src="/img/landing/saas-1/brands/champion-light.svg" width="160" alt="Champion">
                    </div>
                </a>
            </div>
            <div class="col text-center">
                <a class="swap-image my-1 my-sm-2" href="#">
                    <img class="swap-to" src="/img/landing/saas-1/brands/airbnb-color.svg" width="130" alt="Airbnb">
                    <div class="swap-from">
                        <img class="d-dark-mode-none" src="/img/landing/saas-1/brands/airbnb-gray.svg" width="130" alt="Airbnb">
                        <img class="d-none d-dark-mode-block" src="/img/landing/saas-1/brands/airbnb-light.svg" width="130" alt="Airbnb">
                    </div>
                </a>
            </div>
            <div class="col text-center">
                <a class="swap-image my-1 my-sm-2" href="#">
                    <img class="swap-to" src="/img/landing/saas-1/brands/starcraft-color.svg" width="160" alt="Starcraft">
                    <div class="swap-from">
                        <img class="d-dark-mode-none" src="/img/landing/saas-1/brands/starcraft-gray.svg" width="160" alt="Starcraft">
                        <img class="d-none d-dark-mode-block" src="/img/landing/saas-1/brands/starcraft-light.svg" width="160" alt="Starcraft">
                    </div>
                </a>
            </div>
            <div class="col text-center">
                <a class="swap-image my-1 my-sm-2" href="#">
                    <img class="swap-to" src="/img/landing/saas-1/brands/alpine-color.svg" width="150" alt="Alpine">
                    <div class="swap-from">
                        <img class="d-dark-mode-none" src="/img/landing/saas-1/brands/alpine-gray.svg" width="150" alt="Alpine">
                        <img class="d-none d-dark-mode-block" src="/img/landing/saas-1/brands/alpine-light.svg" width="150" alt="Alpine">
                    </div>
                </a>
            </div>
        </div>
        ...
        <div class="container py-2 py-sm-4 py-lg-5">
            ...
            <div class="row align-items-center position-relative pb-5 pb-lg-0 mb-1 mb-sm-2 mb-md-4 mb-lg-0">
                <div class="col-md-6 col-xl-5 offset-lg-1 order-md-2 pb-2 pb-md-0 mb-4 mb-md-0" data-aos="fade-left" data-aos-duration="500" data-aos-offset="250" data-disable-parallax-down="md">
                    <img class="d-dark-mode-none" src="/img/landing/saas-2/steps/01-light.png" width="525" alt="Image">
                    <img class="d-none d-dark-mode-block" src="/img/landing/saas-2/steps/01-dark.png" width="525" alt="Image">
                </div>
            ...
            <div class="row align-items-center position-relative pb-5 pb-lg-0 mb-1 mb-sm-2 mb-md-4 mb-lg-0">
                <div class="col-md-6 col-xl-5 offset-xl-1 pb-2 pb-md-0 mb-4 mb-md-0" data-aos="fade-right" data-aos-duration="500" data-aos-offset="250" data-disable-parallax-down="md">
                    <img class="d-dark-mode-none" src="/img/landing/saas-2/steps/02-light.png" width="473" alt="Image">
                    <img class="d-none d-dark-mode-block" src="/img/landing/saas-2/steps/02-dark.png" width="473" alt="Image">
                </div>
            ...
            <div class="row align-items-center position-relative">
                <div class="col-md-6 col-xl-5 offset-lg-1 order-md-2 d-md-flex justify-content-end pb-2 pb-md-0 mb-4 mb-md-0" data-aos="fade-left" data-aos-duration="500" data-aos-offset="250" data-disable-parallax-down="md">
                    <img class="d-dark-mode-none" src="/img/landing/saas-2/steps/03-light.png" width="473" alt="Image">
                    <img class="d-none d-dark-mode-block" src="/img/landing/saas-2/steps/03-dark.png" width="473" alt="Image">
                </div>
                <div class="col-md-6 col-lg-5 col-xl-4 offset-xl-1 order-md-1" data-aos="fade-right" data-aos-duration="500" data-aos-offset="250" data-disable-parallax-down="md">
                    <div class="pe-md-4 pe-lg-0">
        ...
        <div class="container position-relative z-2 pt-3 pb-sm-3 pt-sm-4 py-md-5 my-lg-2 my-xl-3 my-xxl-4" data-bs-theme="dark">
            <div class="row align-items-center py-xxl-2" data-aos="fade-up" data-aos-duration="600" data-aos-offset="300" data-disable-parallax-down="md">
                <div class="col-md-6 pb-3 pb-md-0 mb-3 mb-md-0">
                    <img src="/img/about/product/features/01.png" width="620" alt="Image">
                </div>
    ...
    <section class="container pt-5 mt-lg-2 mt-xl-4 mt-xxl-5">
        <div class="row align-items-center pt-2 pt-sm-4 pt-md-5 mt-xl-2 mt-xxl-3" data-aos="fade-up" data-aos-duration="600" data-aos-offset="300" data-disable-parallax-down="md">
            <div class="col-md-7 offset-xl-1 pb-3 pb-md-0 mb-3 mb-md-0 order-md-2">
                <img class="d-dark-mode-none" src="/img/about/product/features/02-light.png" width="744" alt="Image">
                <img class="d-none d-dark-mode-block" src="/img/about/product/features/02-dark.png" width="744" alt="Image">
            </div>
    ...
    <section class="container pt-5 mt-lg-2 mt-xl-4 mt-xxl-5">
        <div class="row align-items-center pt-2 pt-sm-4 pt-md-5 mt-xl-2 mt-xxl-3" data-aos="fade-up" data-aos-duration="600" data-aos-offset="300" data-disable-parallax-down="md">
            <div class="col-md-6 col-lg-5 pb-3 pb-md-0 mb-3 mb-md-0">
                <img src="/img/about/product/features/03.png" width="526" alt="Image">
            </div>
            <div class="col-md-6 col-lg-5 col-xxl-4 offset-lg-1 offset-xxl-2" data-aos="fade-up" data-aos-duration="850" data-aos-offset="200" data-disable-parallax-down="md">
                <div class="ps-md-4 ps-lg-0">
                    ...
                    <p class="pb-2 pb-md-3 mb-xl-4">Morbi et massa fames ac scelerisque sit commodo dignissim faucibus vel quisque proin lectus laoreet sem adipiscing sollicitudin erat massa tellus lorem enim aenean phasellus in hendrerit interdum lorem proin pretium dictum urna suspendisse quis risus et.</p>
                    <a class="btn btn-lg btn-outline-primary rounded-pill" href="#">Start free 14-day trial</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="pt-2 pt-md-0">
        <div class="position-relative pt-lg-3 pt-xl-4 pt-xxl-5">
            ...
            <div class="position-relative z-2 px-md-5">
                <img class="d-block d-dark-mode-none mx-auto" src="/img/landing/saas-2/dash-light.png" width="1076" alt="Image">
                <img class="d-none d-dark-mode-block mx-auto" src="/img/landing/saas-2/dash-dark.png" width="1076" alt="Image">
            </div>
        </div>
    </section>
    ...
    <div class="container pt-md-2 pt-lg-3 pt-xl-4">
        <div class="row pb-5 pt-sm-2 mb-lg-2">
            <div class="col-md-4 col-lg-3 pb-2 pb-md-0 mb-4 mb-md-0">
                <a class="navbar-brand py-0 mb-3 mb-md-4" href="/"><span class="text-primary flex-shrink-0 me-2">
