@extends('layouts.base', ['title' => 'Around UI Kit | Event calendar'])
...
<section class="container pt-5 pb-4">
  <div class="row pt-5 pb-2 pb-sm-3">
    <div class="col-lg-9 offset-lg-3 position-relative z-5">
      <h1 class="pt-lg-4">Event calendar</h1>
      <div class="d-flex flex-wrap flex-md-nowrap justify-content-between pb-3">
        <p class="text-body-secondary">JavaScript plugin to display a calendar of events.</p>
        ...
        <div class="card-body">
          <div class="tab-content">
            <div class="tab-pane fade show active" id="preview1" role="tabpanel">
              <div class="calendar" data-calendar-options='{
                    ...
                    "events": [
                      ...
                      {
                        "title": "Relax yoga",
                        "start": "2024-08-03T12:35",
                        "end": "2024-08-03T14:00",
                        "classNames": ["event-custom-style", "bg-light", "text-nav", "border-0", "rounded-1", "p-2", "ps-3", "border-start", "border-5", "border-danger"]
                      },
                      {
                        "title": "Fly yoga",
                        "start": "2024-08-04T09:00",
                        "end": "2024-08-04T11:00",
                        "classNames": ["event-custom-style", "bg-light", "text-nav", "border-0", "rounded-1", "p-2", "ps-3", "border-start", "border-5", "border-primary"]
                      },
                      {
                        "title": "For pregnant",
                        "start": "2024-08-05T07:30",
                        "end": "2024-08-05T09:40",
                        "classNames": ["event-custom-style", "bg-light", "text-nav", "border-0", "rounded-1", "p-2", "ps-3", "border-start", "border-5", "border-warning"]
                      },
                      {
                        "title": "Beginners",
                        "start": "2024-08-08T11:00",
                        "end": "2024-08-03T13:00",
                        "classNames": ["event-custom-style", "bg-light", "text-nav", "border-0", "rounded-1", "p-2", "ps-3", "border-start", "border-5", "border-success"]
                      },
                      {
                        "title": "Relax yoga",
                        "start": "2024-08-08T12:35",
                        "end": "2024-08-03T14:00",
                        "classNames": ["event-custom-style", "bg-light", "text-nav", "border-0", "rounded-1", "p-2", "ps-3", "border-start", "border-5", "border-danger"]
                      },
                      {
                        ...
                        "end": "2024-08-09T09:40",
                        "classNames": ["event-custom-style", "bg-light", "text-nav", "border-0", "rounded-1", "p-2", "ps-3", "border-start", "border-5", "border-warning"]
                      },
                      {
                        "title": "Fly yoga",
                        "start": "2024-08-10T09:00",
                        "end": "2024-08-10T11:00",
                        "classNames": ["event-custom-style", "bg-light", "text-nav", "border-0", "rounded-1", "p-2", "ps-3", "border-start", "border-5", "border-primary"]
                      },
                      {
                        "title": "Stretching",
                        "start": "2024-08-11T16:30",
                        "end": "2024-08-11T18:00",
                        "classNames": ["event-custom-style", "bg-light", "text-nav", "border-0", "rounded-1", "p-2", "ps-3", "border-start", "border-5", "border-purple"]
                      },
                      {
                        "title": "Healthy back",
                        "start": "2024-08-11T12:00",
                        "end": "2024-08-11T13:30",
                        "classNames": ["event-custom-style", "bg-light", "text-nav", "border-0", "rounded-1", "p-2", "ps-3", "border-start", "border-5", "border-info"]
                      },
                      {
                        "title": "Relax yoga",
                        "start": "2024-08-12T12:35",
                        "end": "2024-08-12T14:00",
                        "classNames": ["event-custom-style", "bg-light", "text-nav", "border-0", "rounded-1", "p-2", "ps-3", "border-start", "border-5", "border-danger"]
                      }
                    ]
                  }'></div>
            ...
            <div class="tab-pane fade" id="html1" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Event calendar example --&gt;
&lt;div class=&quot;calendar&quot; data-calendar-options='{
  &quot;initialDate&quot;: &quot;2024-08-01&quot;,
  &quot;headerToolbar&quot;: {
    &quot;left&quot;: &quot;prev,next today&quot;,
