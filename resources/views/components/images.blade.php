@extends('layouts.base', ['title' => 'Around UI Kit | Images & figures'])
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item" id="imgs">
            ...
            <ul class="nav flex-column border-start ps-3 ms-2 mb-2">
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#image-shapes" data-scroll="data-scroll">Image shapes</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#image-thumbnails" data-scroll="data-scroll">Thumbnails</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#image-figures" data-scroll="data-scroll">Figures with caption</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#image-swap" data-scroll="data-scroll">Image swap on hover</a>
              </li>
            </ul>
          </li>
...
<section class="container pt-5 pb-4">
  <div class="row pt-5 pb-2 pb-sm-3">
    <div class="col-lg-9 offset-lg-3 position-relative z-5">
      <h1 class="pt-lg-4">Images &amp; figures</h1>
      <div class="d-flex flex-wrap flex-md-nowrap justify-content-between pb-3">
        <p class="text-body-secondary">Image styles and figure component for displaying images and text.</p>
        <p class="fs-sm fw-semibold ps-md-4">
          <a class="text-decoration-none text-nowrap" href="https://getbootstrap.com/docs/5.3/content/images/" target="_blank" rel="noopener">
            Bootstrap docs
      ...
      <!-- Image shapes -->
      <section class="card border-0 mb-4" id="image-shapes">
        <div class="card-body pb-0">
          <h2 class="h4 mb-n2">Image shapes</h2>
        </div>
            ...
            <div class="tab-pane fade show active" id="preview1" role="tabpanel">
              <div class="row">
                <div class="col-sm-4 mb-4 mb-sm-2">
                  <img class="d-block mx-auto" src="/img/portfolio/list/04.jpg" width="280" alt="Square image">
                </div>
                <div class="col-sm-4 mb-4 mb-sm-2">
                  <img class="d-block rounded-5 mx-auto" src="/img/portfolio/list/03.jpg" width="280" alt="Rounded image">
                </div>
                <div class="col-sm-4 mb-4 mb-sm-2">
                  <img class="d-block rounded-circle mx-auto" src="/img/portfolio/list/01.jpg" width="280" alt="Circle image">
                </div>
              </div>
            </div>
            <div class="tab-pane fade" id="html1" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Square image (default) --&gt;
...
&lt;!-- Circle image --&gt;
&lt;img src=&quot;assets/img/portfolio/list/01.jpg&quot; class=&quot;rounded-circle&quot; alt=&quot;Circle image&quot;&gt;</code></pre>
            </div>
          </div>
        </div>
      </section>
      ...
      <!-- Thumbnails -->
      <section class="card border-0 mb-4" id="image-thumbnails">
        <div class="card-body pb-0">
        ...
        <div class="card-body">
          <div class="tab-content">
            <div class="tab-pane fade show active" id="preview2" role="tabpanel">
              <div class="row">
                <div class="col-sm-4 mb-4 mb-sm-2">
                  <img class="img-thumbnail rounded-0 d-block mx-auto" src="/img/portfolio/list/04.jpg" width="280" alt="Square image">
                </div>
                <div class="col-sm-4 mb-4 mb-sm-2">
                  <img class="img-thumbnail d-block mx-auto" src="/img/portfolio/list/03.jpg" width="280" alt="Rounded image">
                </div>
                <div class="col-sm-4 mb-4 mb-sm-2">
                  <img class="img-thumbnail d-block rounded-circle mx-auto" src="/img/portfolio/list/01.jpg" width="280" alt="Circle image">
                </div>
              </div>
            </div>
            <div class="tab-pane fade" id="html2" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Square thumbnail --&gt;
...
&lt;!-- Circle thumbnail --&gt;
&lt;img src=&quot;assets/img/portfolio/list/01.jpg&quot; class=&quot;img-thumbnail rounded-circle&quot; alt=&quot;Circle thumbnail&quot;&gt;</code></pre>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="card border-0 mb-4" id="image-figures">
        <div class="card-body pb-0">
          <h2 class="h4 mb-n2">Figures with caption</h2>
        </div>
        <div class="card-header">
          <ul class="nav nav-tabs card-header-tabs flex-nowrap align-items-center mb-n1" role="tablist">
            <li class="nav-item me-3">
          ...
          <div class="tab-content">
            <div class="tab-pane fade show active" id="preview3" role="tabpanel">
              <div class="row">
                <div class="col-sm-4 mb-4 mb-sm-2">
                  <figure class="figure">
                    <img class="figure-img" src="/img/portfolio/list/01.jpg" alt="Figure with caption">
                    <figcaption class="figure-caption">Caption on the left</figcaption>
                  </figure>
                </div>
                <div class="col-sm-4 mb-2">
                  <figure class="figure">
                    <img class="figure-img" src="/img/portfolio/list/02.jpg" alt="Figure with caption">
                    <figcaption class="figure-caption text-center">Caption in the center</figcaption>
                  </figure>
                </div>
                <div class="col-sm-4 mb-2">
                  <figure class="figure">
                    <img class="figure-img" src="/img/portfolio/list/04.jpg" alt="Figure with caption">
            ...
            <div class="tab-pane fade" id="html3" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Caption on the left --&gt;
&lt;figure class=&quot;figure&quot;&gt;
...
&lt;/figure&gt;</code></pre>
      ...
      <!-- Image swap on hover -->
      <section class="card border-0 mb-4" id="image-swap">
        <div class="card-body pb-0">
          <h2 class="h4 mb-n2">Image swap on hover</h2>
        </div>
        <div class="card-header">
          <ul class="nav nav-tabs card-header-tabs flex-nowrap align-items-center mb-n1" role="tablist">
            <li class="nav-item me-3">
          ...
          <div class="tab-content">
            <div class="tab-pane fade show active" id="preview4" role="tabpanel">
              <a class="swap-image" href="#">
                <img class="swap-to" src="/img/landing/saas-1/brands/champion-color.svg" width="180" alt="Champion">
                <div class="swap-from">
                  <img class="d-dark-mode-none" src="/img/landing/saas-1/brands/champion-gray.svg" width="180" alt="Champion">
                  <img class="d-none d-dark-mode-block" src="/img/landing/saas-1/brands/champion-light.svg" width="180" alt="Champion">
                </div>
              </a>
            </div>
            <div class="tab-pane fade" id="html4" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Image swap on hover --&gt;
