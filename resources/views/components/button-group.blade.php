@extends('layouts.base', ['title' => 'Around UI Kit | Button group'])
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item" id="btn-group">
            ...
            <ul class="nav flex-column border-start ps-3 ms-2 mb-2">
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#btn-group-basic" data-scroll="data-scroll">Basic example</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#btn-group-toolbar" data-scroll="data-scroll">Button toolbar</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#btn-group-dropdown" data-scroll="data-scroll">Nested dropdown</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#btn-group-sizing" data-scroll="data-scroll">Sizing</a>
              </li>
            </ul>
          </li>
...
<section class="container pt-5 pb-4">
  <div class="row pt-5 pb-2 pb-sm-3">
    <div class="col-lg-9 offset-lg-3 position-relative z-5">
      <h1 class="pt-lg-4">Button group</h1>
      <div class="d-flex flex-wrap flex-md-nowrap justify-content-between pb-3">
        <p class="text-body-secondary">Groups a series of buttons together on a single line.</p>
        <p class="fs-sm fw-semibold ps-md-4">
          <a class="text-decoration-none text-nowrap" href="https://getbootstrap.com/docs/5.3/components/button-group/" target="_blank" rel="noopener">
            Bootstrap docs
      ...
      <!-- Basic example -->
      <section class="card border-0 mb-4" id="btn-group-basic">
        ...
        <div class="card-body">
          <div class="tab-content">
            <div class="tab-pane fade show active" id="preview1" role="tabpanel">
              <div class="btn-group mb-4 me-2" role="group" aria-label="Solid button group">
                <button class="btn btn-primary" type="button">Left</button>
                <button class="btn btn-primary" type="button">Middle</button>
                <button class="btn btn-primary" type="button">Right</button>
              </div>
              <div class="btn-group mb-4 me-2" role="group" aria-label="Outline button group">
              ...
              <div class="btn-group mb-4 me-2" role="group" aria-label="Pill solid button group">
                <button class="btn btn-secondary rounded-pill rounded-end-0" type="button">Left</button>
                <button class="btn btn-secondary" type="button">Middle</button>
                <button class="btn btn-secondary rounded-pill rounded-start-0" type="button">Right</button>
              </div>
              <div class="btn-group mb-4 me-2" role="group" aria-label="Pill outline button group">
                <button class="btn btn-outline-secondary rounded-pill rounded-end-0" type="button">Left</button>
                <button class="btn btn-outline-secondary" type="button">Middle</button>
                <button class="btn btn-outline-secondary rounded-pill rounded-start-0" type="button">Right</button>
              </div>
            </div>
            <div class="tab-pane fade" id="html1" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Solid button group --&gt;
...
&lt;/div&gt;</code></pre>
      ...
      <!-- Button toolbar -->
      <section class="card border-0 mb-4" id="btn-group-toolbar">
        <div class="card-body pb-0">
          <h2 class="h4 mb-n2">Button toolbar</h2>
        </div>
        <div class="card-header">
          <ul class="nav nav-tabs card-header-tabs flex-nowrap align-items-center mb-n1" role="tablist">
            <li class="nav-item me-3">
        ...
        <div class="card-body">
          <div class="tab-content">
            <div class="tab-pane fade show active" id="preview2" role="tabpanel">
              <div class="btn-toolbar mb-3" role="toolbar" aria-label="Settings toolbar">
                <div class="btn-group me-2 mb-2" role="group" aria-label="Settings group">
                  <button class="btn btn-dark btn-icon" type="button" aria-label="Settings">
                    <i class="ai-settings"></i>
                  </button>
                  <button class="btn btn-secondary btn-icon fs-base" type="button">A</button>
                  <button class="btn btn-secondary btn-icon" type="button" aria-label="List">
                    <i class="ai-list fs-xl"></i>
                  </button>
                  <button class="btn btn-secondary btn-icon" type="button" aria-label="Expand">
                    <i class="ai-maximize"></i>
                  </button>
                </div>
              ...
              <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                ...
                <div class="btn-group mb-2" role="group" aria-label="Third group">
                  <button class="btn btn-outline-secondary" type="button">6</button>
                </div>
              </div>
            </div>
            <div class="tab-pane fade" id="html2" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Toolbar example --&gt;
&lt;div class=&quot;btn-toolbar&quot; role=&quot;toolbar&quot; aria-label=&quot;Settings toolbar&quot;&gt;
  &lt;div class=&quot;btn-group me-2 mb-2&quot; role=&quot;group&quot; aria-label=&quot;Settings group&quot;&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-dark btn-icon&quot; aria-label=&quot;Settings&quot;&gt;
      &lt;i class=&quot;ai-settings&quot;&gt;&lt;/i&gt;
    &lt;/button&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-secondary btn-icon fs-base&quot;&gt;A&lt;/button&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-secondary btn-icon&quot; aria-label=&quot;List&quot;&gt;
      &lt;i class=&quot;ai-list fs-xl&quot;&gt;&lt;/i&gt;
    &lt;/button&gt;
    &lt;button type=&quot;button&quot; class=&quot;btn btn-secondary btn-icon&quot; aria-label=&quot;Expand&quot;&gt;
      &lt;i class=&quot;ai-maximize&quot;&gt;&lt;/i&gt;
    &lt;/button&gt;
  &lt;/div&gt;
  &lt;div class=&quot;btn-group me-2 mb-2&quot; role=&quot;group&quot; aria-label=&quot;Apply settings&quot;&gt;
...
&lt;/div&gt;</code></pre>
      ...
      <!-- Nested dropdown -->
      <section class="card border-0 mb-4" id="btn-group-dropdown">
        <div class="card-body pb-0">
          <h2 class="h4 mb-n2">Nested dropdown</h2>
        </div>
        <div class="card-header">
          <ul class="nav nav-tabs card-header-tabs flex-nowrap align-items-center mb-n1" role="tablist">
            <li class="nav-item me-3">
        ...
        <div class="card-body">
          <div class="tab-content">
            ...
            <div class="tab-pane fade" id="html3" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Button group with nested dropdown --&gt;
&lt;div class=&quot;btn-group&quot; role=&quot;group&quot; aria-label=&quot;Button group with nested dropdown&quot;&gt;
...
&lt;/div&gt;</code></pre>
      ...
      <!-- Sizing -->
      <section class="card border-0 mb-4" id="btn-group-sizing">
        <div class="card-body pb-0">
        ...
        <div class="card-header">
          <ul class="nav nav-tabs card-header-tabs flex-nowrap align-items-center mb-n1" role="tablist">
            <li class="nav-item me-3">
              <a class="nav-link px-0 py-2 border-0 rounded-1 active" href="#preview4" data-bs-toggle="tab" role="tab" aria-controls="preview4" aria-selected="true"><i class="ai-show fs-lg opacity-90 me-2"></i>Preview</a>
            </li>
            <li class="vr opacity-20 my-3 me-3"></li>
            <li class="nav-item">
        ...
        <div class="card-body">
          <div class="tab-content">
            ...
            <div class="tab-pane fade" id="html4" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Large button group --&gt;
