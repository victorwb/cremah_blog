@extends('layouts.base', ['title' => 'Around UI Kit | Badges'])
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item" id="badges">
            ...
            <ul class="nav flex-column border-start ps-3 ms-2 mb-2">
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#badges-solid" data-scroll="data-scroll">Solid</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#badges-outline" data-scroll="data-scroll">Outline</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#badges-translucent" data-scroll="data-scroll">Translucent</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#badges-heading" data-scroll="data-scroll">Inside heading</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#badges-button" data-scroll="data-scroll">Inside button</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fs-sm fw-normal py-1 ps-1 pe-0 mb-1" href="#badges-list-group" data-scroll="data-scroll">Inside list group</a>
              </li>
            </ul>
          </li>
...
<section class="container pt-5 pb-4">
  <div class="row pt-5 pb-2 pb-sm-3">
    <div class="col-lg-9 offset-lg-3 position-relative z-5">
      <h1 class="pt-lg-4">Badges</h1>
      <div class="d-flex flex-wrap flex-md-nowrap justify-content-between pb-3">
        <p class="text-body-secondary">Small count and labeling component.</p>
        <p class="fs-sm fw-semibold ps-md-4">
          <a class="text-decoration-none text-nowrap" href="https://getbootstrap.com/docs/5.3/components/badge/" target="_blank" rel="noopener">
            Bootstrap docs
      ...
      <!-- Solid -->
      <section class="card border-0 mb-4" id="badges-solid">
        <div class="card-body pb-0">
          <h2 class="h4 mb-n2">Solid</h2>
        </div>
        ...
        <div class="card-body">
          <div class="tab-content">
            <div class="tab-pane fade show active" id="preview1" role="tabpanel">
              <span class="badge bg-primary fs-sm me-2 mb-2">Primary</span>
              <span class="badge bg-secondary fs-sm me-2 mb-2">Secondary</span>
              <span class="badge bg-success fs-sm me-2 mb-2">Success</span>
              <span class="badge bg-danger fs-sm me-2 mb-2">Danger</span>
              <span class="badge bg-warning fs-sm me-2 mb-2">Warning</span>
              <span class="badge bg-info fs-sm me-2 mb-2">Info</span>
              <div class="d-inline-block mb-2 px-2 py-2 bg-dark">
                <span class="badge bg-light fs-sm">Light</span>
              </div>
              <div class="d-inline-block mb-2 px-2 py-2 bg-white">
                <span class="badge bg-dark fs-sm">Dark</span>
              </div>
            </div>
            <div class="tab-pane fade" id="html1" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Primary solid badge --&gt;
...
&lt;!-- Dark solid badge --&gt;
&lt;span class=&quot;badge bg-dark fs-sm&quot;&gt;Dark&lt;/span&gt;</code></pre>
            </div>
          </div>
        </div>
      </section>
      ...
      <!-- Outline -->
      <section class="card border-0 mb-4" id="badges-outline">
        <div class="card-body pb-0">
        ...
        <div class="card-body">
          <div class="tab-content">
            <div class="tab-pane fade show active" id="preview2" role="tabpanel">
              <span class="badge border border-primary text-primary fs-sm me-2 mb-2">Primary</span>
              <span class="badge border text-nav fs-sm me-2 mb-2">Secondary</span>
              <span class="badge border border-success text-success fs-sm me-2 mb-2">Success</span>
              <span class="badge border border-danger text-danger fs-sm me-2 mb-2">Danger</span>
              <span class="badge border border-warning text-warning fs-sm me-2 mb-2">Warning</span>
              <span class="badge border border-info text-info fs-sm me-2 mb-2">Info</span>
              <div class="d-inline-block mb-2 px-2 py-2 bg-dark">
            ...
            <div class="tab-pane fade" id="html2" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Primary outline badge --&gt;
...
&lt;!-- Dark outline badge --&gt;
&lt;span class=&quot;badge border border-dark text-dark fs-sm&quot;&gt;Dark&lt;/span&gt;</code></pre>
            </div>
          </div>
        </div>
      </section>
      ...
      <!-- Translucent -->
      <section class="card border-0 mb-4" id="badges-translucent">
        <div class="card-body pb-0">
          <h2 class="h4 mb-n2">Translucent</h2>
        </div>
        <div class="card-header">
          <ul class="nav nav-tabs card-header-tabs flex-nowrap align-items-center mb-n1" role="tablist">
            <li class="nav-item me-3">
        ...
        <div class="card-body">
          <div class="tab-content">
            <div class="tab-pane fade show active" id="preview3" role="tabpanel">
              <span class="badge bg-primary bg-opacity-10 text-primary fs-sm me-2 mb-2">Primary</span>
              <span class="badge bg-success bg-opacity-10 text-success fs-sm me-2 mb-2">Success</span>
              <span class="badge bg-danger bg-opacity-10 text-danger fs-sm me-2 mb-2">Danger</span>
              <span class="badge bg-warning bg-opacity-10 text-warning fs-sm me-2 mb-2">Warning</span>
              <span class="badge bg-info bg-opacity-10 text-info fs-sm me-2 mb-2">Info</span>
              <div class="d-inline-block mb-2 px-2 py-2 bg-dark">
            ...
            <div class="tab-pane fade" id="html3" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Primary translucent badge --&gt;
...
&lt;span class=&quot;badge bg-dark bg-opacity-10 text-dark fs-sm&quot;&gt;Dark&lt;/span&gt;</code></pre>
            </div>
          </div>
        </div>
      </section>
      ...
      <!-- Inside heading -->
      <section class="card border-0 mb-4" id="badges-heading">
        <div class="card-body pb-0">
          <h2 class="h4 mb-n2">Inside heading</h2>
        </div>
        <div class="card-header">
          <ul class="nav nav-tabs card-header-tabs flex-nowrap align-items-center mb-n1" role="tablist">
            <li class="nav-item me-3">
        ...
        <div class="card-body">
          <div class="tab-content">
            ...
            <div class="tab-pane fade" id="html4" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;h1&gt;Example heading &lt;span class=&quot;badge bg-secondary&quot;&gt;New&lt;/span&gt;&lt;/h1&gt;
&lt;h2&gt;Example heading &lt;span class=&quot;badge bg-secondary&quot;&gt;New&lt;/span&gt;&lt;/h2&gt;
&lt;h3&gt;Example heading &lt;span class=&quot;badge bg-secondary&quot;&gt;New&lt;/span&gt;&lt;/h3&gt;
&lt;h4&gt;Example heading &lt;span class=&quot;badge bg-secondary&quot;&gt;New&lt;/span&gt;&lt;/h4&gt;
&lt;h5&gt;Example heading &lt;span class=&quot;badge bg-secondary&quot;&gt;New&lt;/span&gt;&lt;/h5&gt;
&lt;h6&gt;Example heading &lt;span class=&quot;badge bg-secondary&quot;&gt;New&lt;/span&gt;&lt;/h6&gt;</code></pre>
      ...
      <!-- Inside button -->
      <section class="card border-0 mb-4" id="badges-button">
        <div class="card-body pb-0">
        ...
        <div class="card-body">
          <div class="tab-content">
            <div class="tab-pane fade show active" id="preview5" role="tabpanel">
              ...
              <button class="btn btn-dark rounded-pill me-3 mb-3" type="button">
            ...
            <div class="tab-pane fade" id="html5" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Button + badge --&gt;
...
&lt;/button&gt;</code></pre>
      ...
      <!-- Inside list group -->
      <section class="card border-0 mb-4" id="badges-list-group">
        <div class="card-body pb-0">
          <h2 class="h4 mb-n2">Inside list group</h2>
        </div>
        <div class="card-header">
          <ul class="nav nav-tabs card-header-tabs flex-nowrap align-items-center mb-n1" role="tablist">
            <li class="nav-item me-3">
        ...
        <div class="card-body">
          <div class="tab-content">
            ...
            <div class="tab-pane fade" id="html6" role="tabpanel">
              <pre class="line-numbers"><code class="lang-html">&lt;!-- Badges inside list group --&gt;
