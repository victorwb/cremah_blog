@extends('layouts.base', ['title' => 'Around | SaaS v.3'])
    ...
    <main class="page-wrapper">
        ...
        <section class="bg-secondary py-5">
            <div class="container text-center pt-5 mt-lg-4 mt-xl-5">
                ...
                <p class="fs-lg pb-3 mb-2 mb-sm-3 mb-lg-4 mx-auto" style="max-width: 640px;">We offer you a new
                    generation of task and project management system. Plan, manage and track all your tasks in one
                    flexible software!</p>
            ...
            <div class="container-fluid overflow-hidden px-4 pt-3 pt-sm-4 pb-sm-2 pb-md-3 py-lg-4 py-xl-5 mt-4">
                <div class="parallax mx-auto" style="max-width: 1440px;">
                    <div class="parallax-layer" data-depth="0.1">
                        <img class="d-dark-mode-none" src="/img/landing/saas-3/hero/01-light.png" alt="Layer">
                        <img class="d-none d-dark-mode-block" src="/img/landing/saas-3/hero/01-dark.png"
                             alt="Layer">
                    </div>
                    <div class="parallax-layer z-2" data-depth="0.25">
                        <img class="d-dark-mode-none" src="/img/landing/saas-3/hero/02-light.png" alt="Layer">
                        <img class="d-none d-dark-mode-block" src="/img/landing/saas-3/hero/02-dark.png"
                             alt="Layer">
                    </div>
                    <div class="parallax-layer z-1" data-depth="0.35">
                        <img class="d-dark-mode-none" src="/img/landing/saas-3/hero/03-light.png" alt="Layer">
                        <img class="d-none d-dark-mode-block" src="/img/landing/saas-3/hero/03-dark.png"
                             alt="Layer">
                    </div>
                    <div class="parallax-layer z-1" data-depth="0.45">
                        <img class="d-dark-mode-none" src="/img/landing/saas-3/hero/04-light.png" alt="Layer">
                        <img class="d-none d-dark-mode-block" src="/img/landing/saas-3/hero/04-dark.png"
                             alt="Layer">
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div class="col">
                    <div class="text-center px-xxl-4">
                        ...
                        <p>Non imperdiet facilisis nulla tellus morbi scelerisque eget adipiscing out vulputate
                            convallis justo sed tellus vehicula.</p>
                    </div>
                </div>
                <div class="col">
                    <div class="text-center px-xxl-4">
                ...
                <div class="col">
                    <div class="text-center px-xxl-4">
                        ...
                        <p>Diam, suspendisse velit cras ac. Lobortis diam volutpat, eget pellentesque viverra inter
                            vivamus id porta fermentum turpis.</p>
                    </div>
                </div>
                <div class="col">
                    <div class="text-center px-xxl-4">
                ...
                <div class="col">
                    <div class="text-center px-xxl-4">
                        ...
                        <p>Aliquam malesuada neque eget elit nulla vestibulum nunc cras. Neque, morbi non arcu sapien
                            luctus ullamcorper lectus efficitur.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="d-flex w-100 position-relative overflow-hidden">
                    ...
                    <div class="mx-n4 mx-sm-n5 mx-xl-0">
                        <div class="mx-n5 mx-xl-0">
                            <img-comparison-slider class="mx-n5 mx-xl-0"><img slot="first"
                                                                              src="/img/landing/saas-3/comparison/light-mode.jpg"
                                                                              alt="Light Mode"><img
                                    class="d-dark-mode-none" slot="second"
                                    src="/img/landing/saas-3/comparison/dark-mode-light.jpg" alt="Dark Mode"><img
                                    class="d-none d-dark-mode-block" slot="second"
                                    src="/img/landing/saas-3/comparison/dark-mode-dark.jpg" alt="Dark Mode">
            ...
            <div class="position-absolute top-0 end-0 w-50 h-100 d-dark-mode-none"
                 style="background-color: #f6f9fc;"></div>
                ...
                <div class="col-lg-5 pb-3 pb-lg-0 mb-3 mb-sm-4 mb-lg-0" data-aos="fade-up" data-aos-duration="850"
                  ...
                  <svg class="position-absolute top-50 end-0 translate-middle-y me-n1 mt-1" width="249" height="46"
                    ...
                    <path class="text-warning" opacity=".4"
                        ...
                        <div
                            class="d-flex align-items-center justify-content-center justify-content-lg-start pt-4 mt-lg-3">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide bg-light">
                                <div class="d-flex flex-column">
                                    <div class="d-flex align-items-center align-self-end pb-3 mb-2 mb-md-3 mb-xl-4"
                                         style="max-width: 570px;">
                                        <div class="bg-light rounded-circle flex-shrink-0 position-relative z-2 me-n5"
                                             style="padding: .375rem;">
                                            <img class="rounded-circle" src="/img/avatar/44.jpg" width="80"
                                                 alt="Avatar">
                                        </div>
                                        <div class="card bg-secondary border-0 rounded-4 py-3 ps-4 ps-sm-5 pe-3">
                                            <div class="card-body py-3 px-2 p-sm-4 ms-4 ms-sm-0">
                                                <p class="fs-xl">"Netus vel, amet placerat eget sit eleifend. Urna
                                                    laoreet ultricies orci feugiat amet egestas semper praesent. Risus
                                                    ut porttitor metus tortor quis eleifend."</p>
                                                <div class="h5 fw-bold mb-0">Nadia Miles</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center align-self-center pb-3 mb-2 mb-md-3 mb-xl-4"
                                         style="max-width: 570px;">
                                        <div class="bg-light rounded-circle flex-shrink-0 position-relative z-2 me-n5"
                                             style="padding: .375rem;">
                                            <img class="rounded-circle" src="/img/avatar/45.jpg" width="80"
                                                 alt="Avatar">
                                        </div>
                                        <div class="card bg-secondary border-0 rounded-4 py-3 ps-4 ps-sm-5 pe-3">
                                            <div class="card-body py-3 px-2 p-sm-4 ms-4 ms-sm-0">
                                                <p class="fs-xl">"Sit facilisis dolor arcu, fermentum vestibulum arcu
                                                    elementum imperdiet. Mauris duis eleifend faucibus amet sagittis
                                                    amet consequat aucibus cursus."</p>
                                    ...
                                    <div class="d-flex align-items-center align-self-end" style="max-width: 570px;">
                                        <div class="bg-light rounded-circle flex-shrink-0 position-relative z-2 me-n5"
                                             style="padding: .375rem;">
                                            <img class="rounded-circle" src="/img/avatar/46.jpg" width="80"
                                                 alt="Avatar">
                                        </div>
                                        <div class="card bg-secondary border-0 rounded-4 py-3 ps-4 ps-sm-5 pe-3">
                                            <div class="card-body py-3 px-2 p-sm-4 ms-4 ms-sm-0">
                                                <p class="fs-xl">"Morbi ut aliquam etiam luctus feugiat ultrices. Amet
                                                    pellentesque sagittis, consequat id egestas tristique turpis. Arcu
                                                    odio ultricies blandit eu neque."</p>
                            ...
                            <div class="swiper-slide bg-light">
                                <div class="d-flex flex-column">
                                    <div class="d-flex align-items-center align-self-center pb-3 mb-2 mb-md-3 mb-xl-4"
                                        ...
                                        <div class="bg-light rounded-circle flex-shrink-0 position-relative z-2 me-n5"
                                             style="padding: .375rem;">
                                            <img class="rounded-circle" src="/img/avatar/47.jpg" width="80"
                                                 alt="Avatar">
                                        </div>
                                        <div class="card bg-secondary border-0 rounded-4 py-3 ps-4 ps-sm-5 pe-3">
                                            <div class="card-body py-3 px-2 p-sm-4 ms-4 ms-sm-0">
                                    ...
                                    <div class="d-flex align-items-center align-self-end pb-3 mb-2 mb-md-3 mb-xl-4"
                                        ...
                                        <div class="bg-light rounded-circle flex-shrink-0 position-relative z-2 me-n5"
                                             style="padding: .375rem;">
                                            <img class="rounded-circle" src="/img/avatar/48.jpg" width="80"
                                                 alt="Avatar">
                                        </div>
                                        <div class="card bg-secondary border-0 rounded-4 py-3 ps-4 ps-sm-5 pe-3">
                                            <div class="card-body py-3 px-2 p-sm-4 ms-4 ms-sm-0">
                                    ...
                                    <div class="d-flex align-items-center align-self-center" style="max-width: 570px;">
                                        <div class="bg-light rounded-circle flex-shrink-0 position-relative z-2 me-n5"
                                             style="padding: .375rem;">
                                            <img class="rounded-circle" src="/img/avatar/49.jpg" width="80"
                                                 alt="Avatar">
                                        </div>
                                        <div class="card bg-secondary border-0 rounded-4 py-3 ps-4 ps-sm-5 pe-3">
                                            <div class="card-body py-3 px-2 p-sm-4 ms-4 ms-sm-0">
        ...
        <section class="container pb-5 mb-xl-3 mb-xxl-5" data-aos="fade-up" data-aos-duration="600"
            ...
            <div class="row align-items-center pb-3 pb-md-4 pb-lg-5">
                <div class="col-md-6 col-lg-7 pb-3 pb-sm-4 pb-md-0">
                    <img class="d-dark-mode-none" src="/img/landing/saas-3/mobile-app-light.jpg" width="636"
                         alt="Mobile screens">
                    <img class="d-none d-dark-mode-block" src="/img/landing/saas-3/mobile-app-dark.jpg"
                         width="636" alt="Mobile screens">
                </div>
                <div class="col-md-6 col-lg-5" data-aos="fade-up" data-aos-duration="850" data-aos-offset="150"
                     data-disable-parallax-down="lg">
                    <h2 class="h1 text-center text-md-start pb-4 pb-lg-5 mb-1 mb-md-2 mb-lg-0 mb-xxl-2">Download our app<br
                            class="d-none d-md-inline"> for any devices</h2>
                    <div class="d-flex justify-content-between mx-auto mx-md-0" style="max-width: 450px;">
                        <div class="pe-3">
                            <p class="text-body-secondary mb-2">App Store</p>
                            ...
                            <p class="pb-2 pb-sm-3 pb-md-4 pb-xl-5">rating 4.7, 187K+ reviews</p>
                            <a class="btn btn-dark btn-lg px-3 py-2" href="#">
                                <img class="d-dark-mode-none mx-1" src="/img/market/appstore-light.svg"
                        ...
                        <div class="ps-3">
                            <p class="text-body-secondary mb-2">Google Play</p>
                            <div class="d-flex mb-3">
                                <i class="ai-star-filled text-warning me-1"></i>
                                <i class="ai-star-filled text-warning me-1"></i>
                                <i class="ai-star-filled text-warning me-1"></i>
                            ...
                            <p class="pb-2 pb-sm-3 pb-md-4 pb-xl-5">rating 4.7, 187K+ reviews</p>
                            <a class="btn btn-dark btn-lg px-3 py-2" href="#">
                                <img class="d-dark-mode-none mx-1" src="/img/market/googleplay-light.svg"
                    ...
                    <div class="row justify-content-center py-xxl-2">
                        <div class="col-lg-8 col-xxl-7">
                            <div class="card h-100 border-0 bg-transparent px-xl-4">
                                ...
                                <div class="position-absolute top-0 start-0 text-warning z-1 mt-n3 ms-n4"
                                     data-aos="zoom-in" data-aos-duration="400" data-aos-delay="600"
                        ...
                        <div class="col-lg-4 offset-xxl-1">
                            <div class="card h-100 border-0 bg-transparent rounded-0 ps-4 ps-xxl-0">
                                ...
                                <div class="card-body px-0 pt-0" style="flex: 0;"><a class="btn btn-lg btn-light"
                                                                                     href="#">Try for free</a></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="position-relative py-5" style="margin-top: -250px;">
            ...
            <div class="container position-relative z-2 py-2 py-sm-3 py-md-4 py-lg-5 mb-sm-2 mb-md-3 mb-xxl-5 my-xl-4">
                <h2 class="h1 text-center pt-xxl-3 pb-3 mb-lg-4 mx-auto" style="max-width: 850px;">Integrate your
                    favorite tools to complete your workflow</h2>
                    ...
                    <div class="col">
                        <div class="card h-100 border-0 rounded-4">
                            ...
                            <div class="card-body position-relative z-2">
                                <img class="d-block mb-4" src="/img/landing/saas-3/tools/google.svg" alt="Google">
                    ...
                    <div class="col">
                        <div class="card h-100 border-0 rounded-4">
                            <div
                                class="bg-secondary position-absolute top-0 start-0 w-100 h-100 rounded-4 d-none d-dark-mode-block"></div>
                            <div class="card-body position-relative z-2">
                                <img class="d-block mb-4" src="/img/landing/saas-3/tools/zoom.svg" alt="Zoom">
                    ...
                    <div class="col">
                        <div class="card h-100 border-0 rounded-4">
                            <div
                                class="bg-secondary position-absolute top-0 start-0 w-100 h-100 rounded-4 d-none d-dark-mode-block"></div>
                            <div class="card-body position-relative z-2">
                                <img class="d-block mb-4" src="/img/landing/saas-3/tools/slack.svg" alt="Slack">
                                <p class="mb-0">Donec blandit nulla elementum eu. Est dui nibh eget amet curabitur
                                    nunc.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card h-100 border-0 rounded-4">
                            <div
                                class="bg-secondary position-absolute top-0 start-0 w-100 h-100 rounded-4 d-none d-dark-mode-block"></div>
                            <div class="card-body position-relative z-2">
                                <img class="d-block mb-4" src="/img/landing/saas-3/tools/gmail.svg" alt="Gmail">
                    ...
                    <div class="col">
                        <div class="card h-100 border-0 rounded-4">
                            <div
                                class="bg-secondary position-absolute top-0 start-0 w-100 h-100 rounded-4 d-none d-dark-mode-block"></div>
                            <div class="card-body position-relative z-2">
                                <img class="d-block mb-4" src="/img/landing/saas-3/tools/trello.svg" alt="Trello">
                                <p class="mb-0">Congue pellentesque amet, viverra curabitur quam diam scelerisque
                                    fermentum urna.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card h-100 border-0 rounded-4">
                            <div
                                class="bg-secondary position-absolute top-0 start-0 w-100 h-100 rounded-4 d-none d-dark-mode-block"></div>
                            <div class="card-body position-relative z-2">
                                <img class="d-block mb-4" src="/img/landing/saas-3/tools/mailchimp.svg"
                                     alt="Mailchimp">
                                <p class="mb-0">Turpis fermentum, volutpat ultrices sed ultrices proin risus bibendum
                                    elit purus.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card h-100 border-0 rounded-4">
                            <div
                                class="bg-secondary position-absolute top-0 start-0 w-100 h-100 rounded-4 d-none d-dark-mode-block"></div>
                            <div class="card-body position-relative z-2">
                                <img class="d-block mb-4" src="/img/landing/saas-3/tools/dropbox.svg"
                                     alt="Dropbox">
                    ...
                    <div class="col">
                        <div class="card h-100 border-0 rounded-4">
                            <div
                                class="bg-secondary position-absolute top-0 start-0 w-100 h-100 rounded-4 d-none d-dark-mode-block"></div>
                            <div class="card-body position-relative z-2">
                                <img class="d-block mb-4" src="/img/landing/saas-3/tools/evernote.svg"
                                     alt="Evernote">
                                <p class="mb-0">Arcu, lorem facilisis nunc tellus, molestie urna nam mi, ullamcorper
                                    tempus quis.</p>
                            </div>
                        </div>
                    </div>
        ...
        <section class="bg-primary pb-2 py-sm-3 py-md-4 py-lg-5">
            <div class="container py-5 my-lg-2 my-xl-4 my-xxl-5">
                <div class="text-center mx-auto" style="max-width: 700px;" data-aos="fade-up" data-aos-duration="500"
                    ...
                    <p class="h2 text-light mb-4">Organize your tasks with a <span class="text-warning">14-day free trial</span>
                    </p>
        ...
        <div class="container py-5 my-sm-2 my-md-3 my-lg-4 my-xl-5">
            <div class="row align-items-start text-center text-lg-start py-xxl-3">
                <div class="col-lg-6 pb-1 pb-sm-2 pb-lg-0 mb-4 mb-lg-0">
                    ...
                    <a class="h1 text-primary" href="mailto:email@example.com">email@example.com</a>
                </div>
                <div class="col-lg-6 d-flex justify-content-center justify-content-lg-end">
                    <a class="btn btn-dark btn-lg px-3 py-2" href="#">
                        <img class="d-dark-mode-none mx-1" src="/img/market/appstore-light.svg" width="136"
                             alt="App Store">
                        <img class="d-none d-dark-mode-block mx-1" src="/img/market/appstore-dark.svg" width="136"
                             alt="App Store">
                    </a>
            ...
            <div class="row align-items-center py-2 py-sm-3">
                <div class="col-md-4 order-md-2 mb-4 mb-md-0">
                    <div class="d-flex justify-content-center justify-content-md-end gap-3">
                        <a class="btn btn-secondary btn-icon btn-sm btn-facebook rounded-circle" href="#"
                           aria-label="Facebook">
                            <i class="ai-facebook"></i>
                        </a>
                        <a class="btn btn-secondary btn-icon btn-sm btn-linkedin rounded-circle" href="#"
                           aria-label="LinkedIn">
                            <i class="ai-linkedin"></i>
                        </a>
                        <a class="btn btn-secondary btn-icon btn-sm btn-telegram rounded-circle" href="#"
                           aria-label="Telegram">
                            <i class="ai-telegram"></i>
                        </a>
                        <a class="btn btn-secondary btn-icon btn-sm btn-youtube rounded-circle" href="#"
                           aria-label="YouTube">
