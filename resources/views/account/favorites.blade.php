            ...
            <div class="row pt-sm-2 pt-lg-0">
                ...
                <div class="col-lg-9 pt-4 pb-2 pb-sm-4">
                    <div class="d-flex align-items-center mb-4">
                        <h1 class="h2 mb-0">Favorites <span
                                class="fs-base fw-normal text-body-secondary">(6 items)</span></h1>
                            ...
                            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">
                                ...
                                <div class="col pb-2 pb-sm-3">
                                            ...
                                            <a class="swiper-wrapper"
                                               href="{{ route('third', ['pages', 'shop', 'single'])}}">
                                                <div class="swiper-slide p-2 p-xl-4">
                                                    <img class="d-block mx-auto" src="/img/shop/products/02.png"
                                                         width="226" alt="Product">
                                                </div>
                                            </a>
                                            <button
                                    ...
                                    <div class="d-flex mb-1">
                                        <h3 class="h6 mb-0">
                                            <a href="{{ route('third', ['pages', 'shop', 'single'])}}">Dispenser for
                                                soap</a>
                                        </h3>
                                    </div>
                                ...
                                <div class="col pb-2 pb-sm-3">
                                    <div class="card-hover position-relative bg-secondary rounded-1 p-3 mb-4">
                                        ...
                                        <div class="swiper swiper-nav-onhover"
                                            ...
                                            <a class="swiper-wrapper"
                                               href="{{ route('third', ['pages', 'shop', 'single'])}}">
                                                <div class="swiper-slide p-2 p-xl-4">
                                                    <img class="d-block mx-auto" src="/img/shop/products/01.png"
                                                         width="226" alt="Product">
                                                </div>
                                            </a>
                                            <button
                                    ...
                                    <div class="d-flex mb-1">
                                        <h3 class="h6 mb-0">
                                            <a href="{{ route('third', ['pages', 'shop', 'single'])}}">Loft style
                                                lamp</a>
                                        </h3>
                                        <div class="d-flex ps-2 mt-n1 ms-auto">
                                            <div class="ms-1">
                                                <input class="btn-check" type="radio" name="color1" value="Dark gray"
                                                       checked id="color1-1">
                                            ...
                                            <div class="ms-1">
                                                <input class="btn-check" type="radio" name="color1" value="Blue"
                                                       id="color1-3">
                                                <label class="btn btn-icon btn-xs btn-outline-secondary rounded-circle"
                                                       for="color1-3">
                                                    <span class="d-block rounded-circle"
                                ...
                                <div class="col pb-2 pb-sm-3">
                                    <div class="card-hover position-relative bg-secondary rounded-1 p-3 mb-4">
                                        ...
                                        <div class="swiper swiper-nav-onhover"
                                            ...
                                            <a class="swiper-wrapper"
                                               href="{{ route('third', ['pages', 'shop', 'single'])}}">
                                                <div class="swiper-slide p-2 p-xl-4">
                                                    <img class="d-block mx-auto" src="/img/shop/products/03.png"
                                                         width="226" alt="Product">
                                                </div>
                                            </a>
                                            <button
                                    ...
                                    <div class="d-flex mb-1">
                                        <h3 class="h6 mb-0">
                                            <a href="{{ route('third', ['pages', 'shop', 'single'])}}">Glossy round
                                                vase</a>
                                        </h3>
                                        <div class="d-flex ps-2 mt-n1 ms-auto">
                                            <div class="ms-1">
                                                <input class="btn-check" type="radio" name="color2" value="Light gray"
                                                       checked id="color2-1">
                                                <label class="btn btn-icon btn-xs btn-outline-secondary rounded-circle"
                                                       for="color2-1">
                                                    <span class="d-block rounded-circle"
                                ...
                                <div class="col pb-2 pb-sm-3">
                                    <div class="card-hover position-relative bg-secondary rounded-1 p-3 mb-4">
                                        ...
                                        <div class="swiper swiper-nav-onhover"
                                            ...
                                            <a class="swiper-wrapper"
                                               href="{{ route('third', ['pages', 'shop', 'single'])}}">
                                                <div class="swiper-slide p-2 p-xl-4">
                                                    <img class="d-block mx-auto" src="/img/shop/products/06.png"
                                                         width="226" alt="Product">
                                                </div>
                                            </a>
                                            <button
                                    ...
                                    <div class="d-flex mb-1">
                                        <h3 class="h6 mb-0">
                                            <a href="{{ route('third', ['pages', 'shop', 'single'])}}">Living room
                                                table</a>
                                        </h3>
                                    </div>
                                ...
                                <div class="col pb-2 pb-sm-3">
                                    <div class="card-hover position-relative bg-secondary rounded-1 p-3 mb-4">
                                        ...
                                        <div class="swiper swiper-nav-onhover"
                                            ...
                                            <a class="swiper-wrapper"
                                               href="{{ route('third', ['pages', 'shop', 'single'])}}">
                                                <div class="swiper-slide p-2 p-xl-4">
                                                    <img class="d-block mx-auto" src="/img/shop/products/04.png"
                                                         width="226" alt="Product">
                                                </div>
                                            </a>
                                            <button
                                    ...
                                    <div class="d-flex mb-1">
                                        <h3 class="h6 mb-0">
                                            <a href="{{ route('third', ['pages', 'shop', 'single'])}}">Ceramic flower
                                                pot</a>
                                        </h3>
                                        <div class="d-flex ps-2 mt-n1 ms-auto">
                                            <div class="ms-1">
                                                <input class="btn-check" type="radio" name="color3"
                                                       value="Gray concrete" checked id="color3-1">
                                                <label class="btn btn-icon btn-xs btn-outline-secondary rounded-circle"
                                                       for="color3-1">
                                                    <span
                                                        class="d-block bg-size-cover bg-position-center rounded-circle"
                                                        style="width: .625rem; height: .625rem; background-color: #c0c0c0; background-image: url(/img/shop/pattern/marble.jpg);"></span>
                                                </label>
                                            </div>
                                            <div class="ms-1">
                                                ...
                                                <label class="btn btn-icon btn-xs btn-outline-secondary rounded-circle"
                                                       for="color3-2">
                                                    <span class="d-block rounded-circle"
                                                          style="width: .625rem; height: .625rem; background-color: #d9c9a1;"></span>
                                                </label>
                                            </div>
                                            <div class="ms-1">
                                    ...
                                    <div class="card-hover position-relative bg-secondary rounded-1 p-3 mb-4">
                                        ...
                                        <div class="swiper swiper-nav-onhover"
                                            ...
                                            <a class="swiper-wrapper"
                                               href="{{ route('third', ['pages', 'shop', 'single'])}}">
                                                <div class="swiper-slide p-2 p-xl-4">
                                                    <img class="d-block mx-auto" src="/img/shop/products/05.png"
                                                         width="226" alt="Product">
                                                </div>
                                            </a>
                                            <button
                                        ...
                                        <div class="d-flex ps-2 mt-n1 ms-auto">
                                            <div class="ms-1">
                                                ...
                                                <label class="btn btn-icon btn-xs btn-outline-secondary rounded-circle"
                                                       for="color4-1">
                                                    <span class="d-block rounded-circle"
                                                          style="width: .625rem; height: .625rem; background-color: #bab8b7;"></span>
                                                </label>
                                            </div>
                                            <div class="ms-1">
                                                ...
                                                <label class="btn btn-icon btn-xs btn-outline-secondary rounded-circle"
                                                    ...
                                                    <span
                                                        class="d-block bg-size-cover bg-position-center rounded-circle"
                                                        style="width: .625rem; height: .625rem; background-color: #c0c0c0; background-image: url(/img/shop/pattern/wood.jpg);"></span>
                                                </label>
                                            </div>
                                            <div class="ms-1">
