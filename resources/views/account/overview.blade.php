                        ...
                        <div class="card-body">
                            ...
                            <div class="d-md-flex align-items-center">
                                <div class="d-sm-flex align-items-center">
                                    <div class="rounded-circle bg-size-cover bg-position-center flex-shrink-0"
                                         style="width: 80px; height: 80px; background-image: url(/img/avatar/02.jpg);"></div>
                            ...
                            <div class="row py-4 mb-2 mb-sm-3">
                                ...
                                <div class="col-md-6 d-md-flex justify-content-end">
                                    <div class="w-100 border rounded-3 p-4" style="max-width: 212px;">
                                        <img class="d-block mb-2" src="/img/account/gift-icon.svg" width="24"
                                             alt="Gift icon">
                            ...
                            <div class="alert alert-info d-flex mb-0" role="alert">
                                ...
                                <div class="ps-2">Fill in the information 100% to receive more suitable offers.<a
                                        class="alert-link ms-1" href="{{ route('second', ['account', 'settings'])}}">Go
                                        to settings!</a></div>
                            </div>
                        </div>
                    </section>
                            ...
                            <div class="card h-100 border-0 py-1 p-md-2 p-xl-3 p-xxl-4">
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-danger d-flex mb-0">
                                        ...
                                        <p class="mb-0">Your primary credit card expired on 01/04/2023. Please add a new
                    ...
                    <section class="card border-0 py-1 p-md-2 p-xl-3 p-xxl-4">
                        <div class="card-body">
                            <div class="d-flex align-items-center mt-sm-n1 pb-4 mb-0 mb-lg-1 mb-xl-3">
                                ...
                                <a class="btn btn-sm btn-secondary ms-auto"
                                   href="{{ route('second', ['account', 'orders'])}}">View all</a>
                            </div>
