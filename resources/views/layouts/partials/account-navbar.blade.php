    ...
    <div class="container">
        ...
        <div class="dropdown nav d-none d-sm-block order-lg-3">
            ...
            <div class="dropdown-menu dropdown-menu-end my-1">
                ...
                <a class="dropdown-item" href="{{ route('second', ['account', 'overview'])}}">
                    <i class="ai-user-check fs-lg opacity-70 me-2"></i>
                    Overview
                </a>
                <a class="dropdown-item" href="{{ route('second', ['account', 'settings'])}}">
                    <i class="ai-settings fs-lg opacity-70 me-2"></i>
                    Settings
                </a>
                <a class="dropdown-item" href="{{ route('second', ['account', 'billing'])}}">
                ...
                <a class="dropdown-item" href="{{ route('second', ['account', 'orders'])}}">
                    <i class="ai-cart fs-lg opacity-70 me-2"></i>
                    Orders
                </a>
                <a class="dropdown-item" href="{{ route('second', ['account', 'earning'])}}">
                    <i class="ai-activity fs-lg opacity-70 me-2"></i>
                    Earnings
                </a>
                <a class="dropdown-item d-flex align-items-center" href="{{ route('second', ['account', 'chat'])}}">
                    <i class="ai-messages fs-lg opacity-70 me-2"></i>
                    Chat
                    <span class="badge bg-danger ms-auto">4</span>
                </a>
                <a class="dropdown-item" href="{{ route('second', ['account', 'favorites'])}}">
                    <i class="ai-heart fs-lg opacity-70 me-2"></i>
                    Favorites
                </a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="{{ route('second', ['auth', 'signin'])}}">
            ...
            <ul class="navbar-nav navbar-nav-scroll me-auto" style="--ar-scroll-height: 520px;">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="{{ route('second', ['account', 'earning'])}}">Earnings</a>
                        </li>
                ...
                <li class="nav-item dropdown d-sm-none border-top mt-2 pt-2">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <h6 class="dropdown-header fs-xs fw-medium text-body-secondary text-uppercase pt-3 pb-1">
                            Dashboard</h6>
                        <a class="dropdown-item" href="{{ route('second', ['account', 'orders'])}}">
                            <i class="ai-cart fs-lg opacity-70 me-2"></i>
                            Orders
                        ...
                        <a class="dropdown-item" href="{{ route('second', ['account', 'favorites'])}}"><i
                                class="ai-heart fs-lg opacity-70 me-2"></i>Favorites</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ route('second', ['auth', 'signin'])}}">
                            <i class="ai-logout fs-lg opacity-70 me-2"></i>
                            Sign out
