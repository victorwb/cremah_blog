@extends('layouts.base', ['title' => 'Around | Portfolio Slider View'])
                        ...
                        <div class="d-flex flex-column flex-lg-row align-items-center h-100 position-relative z-2">
                            <div class="position-relative w-100 order-lg-2">
                                ...
                                <a href="{{ route('third', ['pages', 'portfolio', 'single-v1'])}}">
                                    <img class="d-block position-relative z-2 mx-auto scale-up" src="/img/portfolio/slider/01.png" width="748" alt="Image">
                                </a>
                            </div>
                            <div class="w-100 order-lg-1 px-3 px-lg-4 py-4 pt-lg-0">
                                <div class="text-center text-sm-start mx-auto" style="max-width: 450px;">
                                    <img class="d-block d-dark-mode-none mx-auto mx-sm-0 mb-2 mb-lg-3" src="/img/portfolio/brands/champion-blue-dark.svg" alt="Champion">
                                    <img class="d-none d-dark-mode-block mx-auto mx-sm-0 mb-2 mb-lg-3" src="/img/portfolio/brands/champion-blue-light.svg" alt="Champion">
                                    ...
                                    <a class="btn btn-sm btn-outline-dark fs-sm rounded-pill" href="{{ route('third', ['pages', 'portfolio', 'single-v1'])}}">Read the full story</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="position-relative h-100">
                        ...
                        <div class="d-flex flex-column flex-lg-row align-items-center h-100 position-relative z-2">
                            <div class="position-relative w-100 order-lg-2">
                                ...
                                <a href="{{ route('third', ['pages', 'portfolio', 'single-v1'])}}">
                                    <img class="d-block position-relative z-2 ms-auto from-end" src="/img/portfolio/slider/02.png" width="748" alt="Image">
                                </a>
                            </div>
                            <div class="w-100 order-lg-1 px-3 px-lg-4 py-4 pt-lg-0">
                                <div class="text-center text-sm-start mx-auto" style="max-width: 450px;">
                                    <img class="d-block mx-auto mx-sm-0 mb-2 mb-lg-3" src="/img/portfolio/brands/boost.svg" alt="Boost">
                    ...
                    <div class="position-relative h-100">
                        ...
                        <div class="d-flex flex-column flex-lg-row align-items-center h-100 position-relative z-2">
                            <div class="position-relative w-100 order-lg-2">
                                ...
                                <a href="{{ route('third', ['pages', 'portfolio', 'single-v1'])}}">
                                    <img class="d-block position-relative z-2 mx-auto scale-up" src="/img/portfolio/slider/03.png" width="748" alt="Image">
                                </a>
                            </div>
                            <div class="w-100 order-lg-1 px-3 px-lg-4 py-4 pt-lg-0">
                                <div class="text-center text-sm-start mx-auto" style="max-width: 450px;">
                                    <img class="d-block mx-auto mx-sm-0 mb-2 mb-lg-3" src="/img/portfolio/brands/foster-green.svg" alt="Foster">
                    ...
                    <div class="position-relative h-100">
                        ...
                        <div class="d-flex flex-column flex-lg-row align-items-center h-100 position-relative z-2">
                            <div class="position-relative w-100 order-lg-2">
                                ...
                                <a href="{{ route('third', ['pages', 'portfolio', 'single-v1'])}}">
                                    <img class="d-block position-relative z-2 mx-auto scale-up" src="/img/portfolio/slider/04.png" width="748" alt="Image">
                                </a>
                            </div>
                            <div class="w-100 order-lg-1 px-3 px-lg-4 py-4 pt-lg-0">
                                <div class="text-center text-sm-start mx-auto" style="max-width: 450px;">
                                    <img class="d-block d-dark-mode-none mx-auto mx-sm-0 mb-2 mb-lg-3" src="/img/portfolio/brands/champion-purple-dark.svg" alt="Champion">
                                    <img class="d-none d-dark-mode-block mx-auto mx-sm-0 mb-2 mb-lg-3" src="/img/portfolio/brands/champion-purple-light.svg" alt="Champion">
