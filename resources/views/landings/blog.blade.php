                ...
                <div class="col-md-7 pb-2 pb-md-0 mb-4 mb-md-0">
                    ...
                    <article class="pb-5 pt-sm-1 mb-lg-3 mb-xl-4">
                        <a href="{{ route('third', ['pages', 'blog', 'single-v1'])}}">
                            <img class="rounded-5" src="/img/landing/blog/01.jpg" alt="Image">
                        </a>
                        <h2 class="h3 pt-3 mt-2 mt-md-3">
                            <a href="{{ route('third', ['pages', 'blog', 'single-v1'])}}">The fashion for eco bags with vintage prints will still be
                    ...
                    <article class="pb-5 pt-sm-1 mb-lg-3 mb-xl-4">
                        <a href="{{ route('third', ['pages', 'blog', 'single-v1'])}}">
                            <img class="rounded-5" src="/img/landing/blog/02.jpg" alt="Image">
                        </a>
                        <h2 class="h3 pt-3 mt-2 mt-md-3">
                            <a href="{{ route('third', ['pages', 'blog', 'single-v1'])}}">How to look for inspiration for new goals in life and remember
                                to give yourself a break?</a>
                        </h2>
                        <p>Egestas in neque scelerisque semper sit at eu cursus faucibus velit cras at aliquam sed
                            dictum at at orci curabitur dictumst viverra non pharetra etiam non, vitae tristique eu in
                            morbi felis...</p>
                        <div class="d-flex flex-wrap align-items-center pt-1 mt-n2">
                            <a class="nav-link text-body-secondary fs-sm fw-normal p-0 mt-2 me-3" href="#">
                                13
                    ...
                    <article class="pb-5 pt-sm-1 mb-lg-3 mb-xl-4">
                        <a href="{{ route('third', ['pages', 'blog', 'single-v1'])}}">
                            <img class="rounded-5" src="/img/landing/blog/03.jpg" alt="Image">
                        </a>
                        <h2 class="h3 pt-3 mt-2 mt-md-3">
                            <a href="{{ route('third', ['pages', 'blog', 'single-v1'])}}">A session with a psychologist as a personal choice or a
                                fashion trend in society</a>
                        </h2>
                        <p>Purus lectus odio lacus nibh habitant ac sapien malesuada sed convallis adipiscing eget
                            convallis amet enim diam tellus sodales ornare vitae molestie nulla tincidunt ac non
                            facilisis faucibus...</p>
                        <div class="d-flex flex-wrap align-items-center pt-1 mt-n2">
                            <a class="nav-link text-body-secondary fs-sm fw-normal p-0 mt-2 me-3" href="#">
                                24
                                <i class="ai-share fs-lg ms-1"></i>
              ...
              "576": {
                "slidesPerView": "auto"
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="card h-100 border-0 mx-auto" style="max-width: 416px;">
                                ...
                                <div class="card-body pb-4">
                                    ...
                                    <h3 class="h4 card-title">
                                        <a href="{{ route('third', ['pages', 'blog', 'single-v1'])}}">Top books for inspiration</a>
                                    </h3>
                                    <p class="card-text">Vulputate auctor lacus imperdiet facilisi tristique nisl
                                        pulvinar porta diam duis...</p>
                                </div>
                        ...
                        <article class="swiper-slide w-sm-auto h-auto">
                            <div class="card h-100 border-0 mx-auto" style="max-width: 416px;">
                                ...
                                <div class="card-body pb-4">
                                    ...
                                    <p class="card-text">Duis consectetur quis enim iaculis eu sagittis posuere
                                        imperdiet scelerisque...</p>
                                </div>
                                <div class="card-footer pt-3">
                                    <a class="d-flex align-items-center text-decoration-none pb-2" href="#">
                        ...
                        <article class="swiper-slide w-sm-auto h-auto">
                            <div class="card h-100 border-0 mx-auto" style="max-width: 416px;">
                                <a href="{{ route('third', ['pages', 'blog', 'single-v3'])}}">
                                ...
                                <div class="card-body pb-4">
                                    ...
                                    <h3 class="h4 card-title">
                                        <a href="{{ route('third', ['pages', 'blog', 'single-v3'])}}">Inspiration in quarantine</a>
                                    </h3>
                                    <p class="card-text">Nec in est vel ac et odio interdum risus maecenas pulvinar
                                        potenti gravida sed...</p>
                                </div>
                                <div class="card-footer pt-3">
                                    <a class="d-flex align-items-center text-decoration-none pb-2" href="#">
                                        <img class="rounded-circle" src="/img/avatar/12.jpg" width="48"
                                             alt="Post author">
                        ...
                        <!-- Item -->
                        <article class="swiper-slide w-sm-auto h-auto">
                            <div class="card h-100 border-0 mx-auto" style="max-width: 416px;"><a
                                    href="{{ route('third', ['pages', 'blog', 'single-v1'])}}"><img class="card-img-top"
                                                                    src="/img/blog/grid/04.jpg" alt="Post image"></a>
                                <div class="card-body pb-4">
                                    <div class="d-flex align-items-center mb-4 mt-n1"><span
                                            class="fs-sm text-body-secondary">July 15, 2022</span><span
                                            class="fs-xs opacity-20 mx-3">|</span><a class="badge text-nav fs-xs border"
                                                                                     href="#">TV Shows</a></div>
                                    <h3 class="h4 card-title"><a href="{{ route('third', ['pages', 'blog', 'single-v1'])}}">New series from Netflix</a>
                                    </h3>
                                    <p class="card-text">Nec gravida senectus donec vivamus quam urna facilisis viverra
                                        eget in suspendisse...</p>
                                </div>
                                <div class="card-footer pt-3"><a
                                        class="d-flex align-items-center text-decoration-none pb-2" href="#">
                        ...
                        <article class="swiper-slide w-sm-auto h-auto">
                            <div class="card h-100 border-0 mx-auto" style="max-width: 416px;">
                                <a href="{{ route('third', ['pages', 'blog', 'single-v2'])}}">
                                    <img class="card-img-top" src="/img/blog/grid/05.jpg" alt="Post image">
                                </a>
                                <div class="card-body pb-4">
                                    <div class="d-flex align-items-center mb-4 mt-n1">
                                    ...
                                    <h3 class="h4 card-title">
                                        <a href="{{ route('third', ['pages', 'blog', 'single-v2'])}}">How to look for inspiration?</a>
                                    </h3>
                                    <p class="card-text">Risus arcu urna nisl massa nec leo tesque ac suspendisse magna
                                        verot ipsum...</p>
                                </div>
                                <div class="card-footer pt-3">
                                    <a class="d-flex align-items-center text-decoration-none pb-2" href="#">
                        ...
                        <article class="swiper-slide w-sm-auto h-auto">
                            <div class="card h-100 border-0 mx-auto" style="max-width: 416px;">
                                <a href="{{ route('third', ['pages', 'blog', 'single-v3'])}}">
                                    <img class="card-img-top" src="/img/blog/grid/06.jpg" alt="Post image">
                                </a>
                                <div class="card-body pb-4">
                                    <div class="d-flex align-items-center mb-4 mt-n1">
                                    ...
                                    <h3 class="h4 card-title">
                                        <a href="{{ route('third', ['pages', 'blog', 'single-v3'])}}">A psychologist as choice</a>
                                    </h3>
                                    <p class="card-text">Eu aenean euismod in tellus ipsum et natoque aliquam maecenas.
                                        Sed lectus...</p>
                                </div>
                                <div class="card-footer pt-3">
                                    <a class="d-flex align-items-center text-decoration-none pb-2" href="#">
                ...
                <div class="col-xl-2">
                    <div
                        ...
                        <div class="d-flex ms-auto ms-xl-0 pe-sm-3 pe-xl-0">
                            <button class="btn btn-sm btn-icon btn-outline-primary rounded-circle me-3" type="button"
                                    id="prev-author" aria-label="Prev">
                                <i class="ai-arrow-left"></i>
                            </button>
                            <button class="btn btn-sm btn-icon btn-outline-primary rounded-circle" type="button"
                                    id="next-author" aria-label="Next">
                                <i class="ai-arrow-right"></i>
                            </button>
                        </div>
                    </div>
                  ...
                  "slidesPerView": "auto"
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide w-xxl-auto">
                                <a class="d-block card-hover text-decoration-none mx-auto" href="#"
                                   style="max-width: 416px;">
                                    <div class="bg-secondary rounded-5 position-relative overflow-hidden">
                                        <div
                                            ...
                                            style="background-image: url(/img/landing/blog/authors/hover.svg);"></div>
                                        <img class="position-relative z-2" src="/img/landing/blog/authors/01.png"
                                             alt="Author picture">
                                    </div>
                                   ...
                                   style="max-width: 416px;">
                                    <div class="bg-secondary rounded-5 position-relative overflow-hidden">
                                        <div
                                            class="position-absolute top-0 start-0 w-100 h-100 bg-size-cover bg-position-center opacity-0"
                                            style="background-image: url(/img/landing/blog/authors/hover.svg);"></div>
                                        <img class="position-relative z-2" src="/img/landing/blog/authors/02.png"
                                             alt="Author picture">
                                    </div>
                                    <div class="border-bottom pt-4 pb-3">
                                   ...
                                   style="max-width: 416px;">
                                    <div class="bg-secondary rounded-5 position-relative overflow-hidden">
                                        <div
                                            class="position-absolute top-0 start-0 w-100 h-100 bg-size-cover bg-position-center opacity-0"
                                            style="background-image: url(/img/landing/blog/authors/hover.svg);"></div>
                                        <img class="position-relative z-2" src="/img/landing/blog/authors/03.png"
                                             alt="Author picture">
                                    </div>
                                    <div class="border-bottom pt-4 pb-3">
                                   ...
                                   style="max-width: 416px;">
                                    <div class="bg-secondary rounded-5 position-relative overflow-hidden">
                                        <div
                                            class="position-absolute top-0 start-0 w-100 h-100 bg-size-cover bg-position-center opacity-0"
                                            style="background-image: url(/img/landing/blog/authors/hover.svg);"></div>
                                        <img class="position-relative z-2" src="/img/landing/blog/authors/04.png"
                                             alt="Author picture">
                                    </div>
                                    <div class="border-bottom pt-4 pb-3">
                                   ...
                                   style="max-width: 416px;">
                                    <div class="bg-secondary rounded-5 position-relative overflow-hidden">
                                        <div
                                            class="position-absolute top-0 start-0 w-100 h-100 bg-size-cover bg-position-center opacity-0"
                                            style="background-image: url(/img/landing/blog/authors/hover.svg);"></div>
                                        <img class="position-relative z-2" src="/img/landing/blog/authors/05.png"
                                             alt="Author picture">
                                    </div>
                                    <div class="border-bottom pt-4 pb-3">
                    ...
                    <article class="swiper-slide h-auto">
                        <div class="card border-0 bg-secondary">
                            <div class="card-body pb-4">
                                ...
                                <p class="card-text">Morbi et massa fames ac scelerisque sit commodo dignissim faucibus
                                    vel quisque...</p>
                            </div>
                            <div class="card-footer pt-3">
                                <a class="d-flex align-items-center text-decoration-none pb-2" href="#">
                    ...
                    <article class="swiper-slide h-auto">
                        <div class="card border-0 bg-secondary">
                            <div class="card-body pb-4">
                                ...
                                <p class="card-text">Nec gravida senectus donec vivamus quam urna facilisis viverra eget
                                    in suspendisse...</p>
                            </div>
                            <div class="card-footer pt-3">
                                <a class="d-flex align-items-center text-decoration-none pb-2" href="#">
